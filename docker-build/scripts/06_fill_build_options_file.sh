...
echo "MYBUILDTYPE=$MYBUILDTYPE" >> "${FILENAME_BUILDOPTIONS}"
echo "MYBUILDTYPEFLAGS=$MYBUILDTYPEFLAGS" >> "${FILENAME_BUILDOPTIONS}"
...
echo "ARTIFACTS_DIR=$ARTIFACTS_DIR" >> "${FILENAME_BUILDOPTIONS}"
