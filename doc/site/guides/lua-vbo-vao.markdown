...
![image]({% link /assets/guides/lua-vbo-vao-1.png %})
...
![image]({% link /assets/guides/lua-vbo-vao-2.png %})
...
![image]({% link /assets/guides/lua-vbo-vao-3.png %})
...
![image]({% link /assets/guides/lua-vbo-vao-4.png %})
