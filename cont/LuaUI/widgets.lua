...
function widgetHandler:ControllerButtonUp(button, value, name)
	for _, w in ipairs(self.ControllerButtonUpList) do
		if w:ControllerButtonUp(button, value, name) then
			return true
		end
	end
	return false
...
function widgetHandler:ControllerButtonDown(button, value, name)
	for _, w in ipairs(self.ControllerButtonDownList) do
		if w:ControllerButtonDown(button, value, name) then
			return true
		end
	end
	return false
