...
struct InputData {
	vec4 info0; // .xyz - position, .w ttl(int32)
...
#define ttl           floatBitsToInt(dataIn[gl_GlobalInvocationID.x].info0.w)
...
[[
	...
	vec4 currColor = GetCurrentColor(color0, color1, edge0, edge1, currTime);
