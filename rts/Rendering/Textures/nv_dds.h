...
public:
	...
	virtual void
	create(unsigned int w, unsigned int h, unsigned int d, unsigned int imgsize, const unsigned char* pixels);
	virtual void clear();
...
public:
	...
	inline void add_mipmap() { m_mipmaps.emplace_back(); }
