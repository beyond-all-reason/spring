...
public:
	...
	static void SetUnitDefImage(const UnitDef* unitDef, unsigned int texID, int xsize, int ysize) { return unitDrawerData->SetUnitDefImage(unitDef, texID, xsize, ysize); }
