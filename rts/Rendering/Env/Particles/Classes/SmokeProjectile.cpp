...
#define st projectileDrawer->GetSmokeTexture(textureNum)
	AddEffectsQuad({drawPos - pos2, st->xstart, st->ystart, col}, {drawPos + pos1, st->xend, st->ystart, col},
	    {drawPos + pos2, st->xend, st->yend, col}, {drawPos - pos1, st->xstart, st->yend, col});
#undef st
}

int CSmokeProjectile::GetProjectilesCount() const { return 1; }
