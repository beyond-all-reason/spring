...
public:
	// DrawFeature*
	virtual void DrawFeatureNoTrans(const CFeature* feature,
	    unsigned int preList,
	    unsigned int postList,
	    bool lodCall,
	    bool noLuaCall) const = 0;
	virtual void DrawFeatureTrans(const CFeature* feature,
	    unsigned int preList,
	    unsigned int postList,
	    bool lodCall,
	    bool noLuaCall) const = 0;
...
protected:
	...
	void DrawShadowObjectsLua() const override { eventHandler.DrawShadowFeaturesLua(); }
...
public:
	...
	void DrawShadowPass() const override { DrawShadowPassImpl<true, LuaObjType::LUAOBJ_FEATURE>(); }

	void DrawFeatureNoTrans(const CFeature* feature,
	    unsigned int preList,
	    unsigned int postList,
	    bool lodCall,
	    bool noLuaCall) const override;
	void DrawFeatureTrans(const CFeature* feature,
	    unsigned int preList,
	    unsigned int postList,
	    bool lodCall,
	    bool noLuaCall) const override;
...
public:
	...
	void DrawShadowPass() const override { DrawShadowPassImpl<false, LuaObjType::LUAOBJ_FEATURE>(); }
