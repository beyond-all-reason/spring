 ...
 */
asio::ip::address WrapIP(const std::string& ip, asio::error_code* err = NULL);
...
WrapResolve(asio::ip::udp::resolver& resolver, asio::ip::udp::resolver::query& query, asio::error_code* err = NULL);
