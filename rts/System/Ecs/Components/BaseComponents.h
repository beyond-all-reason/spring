...
template<class T> struct BasicClassComponentType {
	T value;
};

template<class T> struct BasicComponentType {
	T value = {};
};

template<> struct BasicComponentType<entt::entity> {
...
#define VOID_COMPONENT(Component) \
	struct Component {};
