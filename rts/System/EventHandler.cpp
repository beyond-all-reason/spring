...
bool CEventHandler::ControllerRemapped(int instanceId)
{
	return ControlReverseIterateDefTrue(listControllerRemapped, &CEventClient::ControllerRemapped, instanceId);
}
