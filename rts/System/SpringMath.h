...
template<typename T> inline T argmin(const T v1, const T v2) { return std::min(v1, v2); }
template<typename T> inline T argmax(const T v1, const T v2) { return std::max(v1, v2); }
