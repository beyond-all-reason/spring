...
CONFIG(bool, FontConfigApplySubstitutions).defaultValue(true).description("Whether fontconfig config substitutions will take place while searching. Disabling risks unknown breakage, but enabled has a nontrivial performance cost.");
