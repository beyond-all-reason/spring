...
static const std::function<bool(const Key&, const Key&)> keyCmp = [](const Key& a, const Key& b) {
...
bool GetKeyModState(int mod) { return (keyMods & mod); }
...
const std::vector<Key>& GetPressedKeys() { return keyVec; }

const std::vector<Key>& GetPressedScans() { return scanVec; }
