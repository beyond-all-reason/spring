...
EXPORT(int)
skirmishAiCallback_Engine_handleCommand(int skirmishAIId, int toId, int commandId, int commandTopic, void* commandData);
...
EXPORT(bool)
skirmishAiCallback_DataDirs_Roots_getDir(int UNUSED_skirmishAIId, char* path, int path_sizeMax, int dirIndex);
...
// EXPORT(bool             ) skirmishAiCallback_File_locateForReading(int skirmishAIId, char* fileName, int
// fileName_sizeMax);

// EXPORT(bool             ) skirmishAiCallback_File_locateForWriting(int skirmishAIId, char* fileName, int
// fileName_sizeMax);
...
EXPORT(int)
skirmishAiCallback_UnitDef_getYardMap(int skirmishAIId, int unitDefId, int facing, short* yardMap, int yardMap_sizeMax);
...
EXPORT(int)
skirmishAiCallback_UnitDef_getBuildOptions(int skirmishAIId, int unitDefId, int* unitDefIds, int unitDefIds_sizeMax);
...
EXPORT(float)
skirmishAiCallback_Unit_getRulesParamFloat(int skirmishAIId,
    int unitId,
...
EXPORT(bool)
skirmishAiCallback_Unit_SupportedCommand_isShowUnique(int skirmishAIId, int unitId, int supportedCommandId);
...
EXPORT(float)
skirmishAiCallback_Team_getRulesParamFloat(int skirmishAIId,
    int teamId,
    const char* rulesParamName,
    float defaultValue);
...
EXPORT(bool)
skirmishAiCallback_Group_SupportedCommand_isDisabled(int skirmishAIId, int groupId, int supportedCommandId);
...
EXPORT(int)
skirmishAiCallback_Group_OrderPreview_getParams(int skirmishAIId, int groupId, float* params, int params_sizeMax);
...
EXPORT(int)
skirmishAiCallback_Map_getCornersHeightMap(int skirmishAIId, float* cornerHeights, int cornerHeights_sizeMax);
...
EXPORT(int)
skirmishAiCallback_Map_getSonarJammerMap(int skirmishAIId, int* sonarJammerValues, int sonarJammerValues_sizeMax);

EXPORT(int)
skirmishAiCallback_Map_getResourceMapRaw(int skirmishAIId, int resourceId, short* resources, int resources_sizeMax);

EXPORT(int)
skirmishAiCallback_Map_getResourceMapSpotsPositions(int skirmishAIId,
    int resourceId,
    float* spots_AposF3,
    int spots_AposF3_sizeMax);

EXPORT(float)
skirmishAiCallback_Map_initResourceMapSpotsNearest(int skirmishAIId,
    int resourceId,
    float* pos_posF3,
    float* return_posF3_out);
...
EXPORT(int)
skirmishAiCallback_Map_getSpeedModMap(int skirmishAIId, int speedModClass, float* speedMods, int speedMods_sizeMax);
...
EXPORT(int)
skirmishAiCallback_WeaponDef_Damage_getTypes(int skirmishAIId, int weaponDefId, float* types, int types_sizeMax);
