...
struct SSkirmishAICallback {
	 ...
	 */
	int(CALLING_CONV* Engine_handleCommand)(int skirmishAIId,
	    int toId,
	    int commandId,
	    int commandTopic,
	    void* commandData);
	 ...
	 */
	bool(CALLING_CONV* DataDirs_locatePath)(int skirmishAIId,
	    char* path,
	    int path_sizeMax,
	    ...
	    bool create,
	    bool dir,
	    bool common); //$ RET_STRING:path:path_sizeMax
	...
	bool(CALLING_CONV* DataDirs_Roots_getDir)(int skirmishAIId,
	    char* path,
	    int path_sizeMax,
	    int dirIndex); //$ RET_STRING:path:path_sizeMax
	 ...
	 *          -> the path exists and is stored in an absolute form in path
	 */
	bool(CALLING_CONV* DataDirs_Roots_locatePath)(int skirmishAIId,
	    char* path,
	    int path_sizeMax,
	    const char* const relPath,
	    bool writeable,
	    bool create,
	    bool dir); //$ RET_STRING:path:path_sizeMax
	 ...
	 */
	const char*(CALLING_CONV* Game_getRulesParamString)(int skirmishAIId,
	    const char* gameRulesParamName,
	 ...
	 */
	int(CALLING_CONV* getUnitDefs)(int skirmishAIId,
	    int* unitDefIds,
	    int unitDefIds_sizeMax); //$ FETCHER:MULTI:IDs:UnitDef:unitDefIds
	...
	float(
	    CALLING_CONV* UnitDef_getUpkeep)(int skirmishAIId, int unitDefId, int resourceId); //$ REF:resourceId->Resource

	/** This amount of the resource will always be created. */
	float(CALLING_CONV* UnitDef_getResourceMake)(int skirmishAIId,
	    int unitDefId,
	    int resourceId); //$ REF:resourceId->Resource

	/**
	 * This amount of the resource will be created when the unit is on and enough
	 * energy can be drained.
	 */
	float(CALLING_CONV* UnitDef_getMakesResource)(int skirmishAIId,
	    int unitDefId,
	    int resourceId); //$ REF:resourceId->Resource

	float(CALLING_CONV* UnitDef_getCost)(int skirmishAIId, int unitDefId, int resourceId); //$ REF:resourceId->Resource

	float(CALLING_CONV* UnitDef_getExtractsResource)(int skirmishAIId,
	    int unitDefId,
	    int resourceId); //$ REF:resourceId->Resource

	float(CALLING_CONV* UnitDef_getResourceExtractorRange)(int skirmishAIId,
	    int unitDefId,
	    int resourceId); //$ REF:resourceId->Resource

	float(CALLING_CONV* UnitDef_getWindResourceGenerator)(int skirmishAIId,
	    int unitDefId,
	    int resourceId); //$ REF:resourceId->Resource

	float(CALLING_CONV* UnitDef_getTidalResourceGenerator)(int skirmishAIId,
	    int unitDefId,
	    int resourceId); //$ REF:resourceId->Resource

	float(
	    CALLING_CONV* UnitDef_getStorage)(int skirmishAIId, int unitDefId, int resourceId); //$ REF:resourceId->Resource
	...
	float(CALLING_CONV* UnitDef_getUpDirSmoothing)(int skirmishAIId, int unitDefId);
	 ...
	 */
	int(CALLING_CONV* UnitDef_getYardMap)(int skirmishAIId,
	    int unitDefId,
	    int facing,
	    short* yardMap,
	    int yardMap_sizeMax); //$ ARRAY:yardMap
	...
	int(CALLING_CONV* UnitDef_getBuildOptions)(int skirmishAIId,
	    int unitDefId,
	    int* unitDefIds,
	    int unitDefIds_sizeMax); //$ REF:MULTI:unitDefIds->UnitDef

	int(CALLING_CONV* UnitDef_getCustomParams)(int skirmishAIId,
	    int unitDefId,
	    const char** keys,
	    const char** values); //$ MAP
	...
	int(CALLING_CONV* UnitDef_WeaponMount_getWeaponDef)(int skirmishAIId,
	    int unitDefId,
	    int weaponMountId); //$ REF:RETURN->WeaponDef

	int(CALLING_CONV* UnitDef_WeaponMount_getSlavedTo)(int skirmishAIId, int unitDefId, int weaponMountId);

	void(CALLING_CONV* UnitDef_WeaponMount_getMainDir)(int skirmishAIId,
	    int unitDefId,
	    int weaponMountId,
	 ...
	 */
	int(CALLING_CONV* getEnemyUnits)(int skirmishAIId,
	    int* unitIds,
	    int unitIds_sizeMax); //$ FETCHER:MULTI:IDs:Unit:unitIds
	 ...
	 */
	int(CALLING_CONV* getEnemyUnitsIn)(int skirmishAIId,
	    float* pos_posF3,
	    float radius,
	    bool spherical,
	    int* unitIds,
	 ...
	 * If cheats are enabled, this will return all enemies on the map.
	 */
	int(CALLING_CONV* getEnemyUnitsInRadarAndLos)(int skirmishAIId,
	    int* unitIds,
	    int unitIds_sizeMax); //$ FETCHER:MULTI:IDs:Unit:unitIds
	 ...
	 * units.
	 */
	int(CALLING_CONV* getFriendlyUnits)(int skirmishAIId,
	    int* unitIds,
	    int unitIds_sizeMax); //$ FETCHER:MULTI:IDs:Unit:unitIds
	 ...
	 */
	int(CALLING_CONV* getFriendlyUnitsIn)(int skirmishAIId,
	    float* pos_posF3,
	    float radius,
	    bool spherical,
	    int* unitIds,
	 ...
	 */
	int(CALLING_CONV* getNeutralUnits)(int skirmishAIId,
	    int* unitIds,
	    int unitIds_sizeMax); //$ FETCHER:MULTI:IDs:Unit:unitIds
	 ...
	 */
	int(CALLING_CONV* getNeutralUnitsIn)(int skirmishAIId,
	    float* pos_posF3,
	    float radius,
	    bool spherical,
	    int* unitIds,
	 ...
	 */
	int(CALLING_CONV* getTeamUnits)(int skirmishAIId,
	    int* unitIds,
	    int unitIds_sizeMax); //$ FETCHER:MULTI:IDs:Unit:unitIds
	 ...
	 */
	int(CALLING_CONV* getSelectedUnits)(int skirmishAIId,
	    int* unitIds,
	    int unitIds_sizeMax); //$ FETCHER:MULTI:IDs:Unit:unitIds
	 ...
	 * @return float value of parameter if it's set, defaultValue otherwise.
	 */
	float(CALLING_CONV* Unit_getRulesParamFloat)(int skirmishAIId,
	    int unitId,
	    const char* unitRulesParamName,
	    float defaultValue);

	/**
	 * @return string value of parameter if it's set, defaultValue otherwise.
	 */
	const char*(CALLING_CONV* Unit_getRulesParamString)(int skirmishAIId,
	    int unitId,
	    const char* unitRulesParamName,
	    const char* defaultValue);
	...
	int(CALLING_CONV* Unit_getCurrentCommands)(int skirmishAIId,
	    int unitId); //$ FETCHER:MULTI:NUM:CurrentCommand-Command
	...
	int(CALLING_CONV* Unit_CurrentCommand_getParams)(int skirmishAIId,
	    int unitId,
	    int commandId,
	    float* params,
	    int params_sizeMax); //$ ARRAY:params

	/** The commands that this unit can understand, other commands will be ignored */
	int(CALLING_CONV* Unit_getSupportedCommands)(int skirmishAIId,
	    int unitId); //$ FETCHER:MULTI:NUM:SupportedCommand-CommandDescription
	...
	int(CALLING_CONV* Unit_SupportedCommand_getParams)(int skirmishAIId,
	    int unitId,
	...
	//	int               (CALLING_CONV *Unit_getResourceInfos)(int skirmishAIId, int unitId); //$
	//FETCHER:MULTI:NUM:ResourceInfo

	float(CALLING_CONV* Unit_getResourceUse)(int skirmishAIId, int unitId, int resourceId); //$ REF:resourceId->Resource

	float(
	    CALLING_CONV* Unit_getResourceMake)(int skirmishAIId, int unitId, int resourceId); //$ REF:resourceId->Resource
	...
	int(CALLING_CONV* Unit_getWeapon)(int skirmishAIId,
	    int unitId,
	    int weaponMountId); //$ REF:weaponMountId->WeaponMount REF:RETURN->Weapon
	                        // END OBJECT Unit
	...
	int(CALLING_CONV* getEnemyTeams)(int skirmishAIId,
	    int* teamIds,
	    int teamIds_sizeMax); //$ FETCHER:MULTI:IDs:Team:teamIds

	int(CALLING_CONV* getAlliedTeams)(int skirmishAIId,
	    int* teamIds,
	    int teamIds_sizeMax); //$ FETCHER:MULTI:IDs:Team:teamIds
	 ...
	 * @return float value of parameter if it's set, defaultValue otherwise.
	 */
	float(CALLING_CONV* Team_getRulesParamFloat)(int skirmishAIId,
	    int teamId,
	    const char* teamRulesParamName,
	    float defaultValue);

	/**
	 * @return string value of parameter if it's set, defaultValue otherwise.
	 */
	const char*(CALLING_CONV* Team_getRulesParamString)(int skirmishAIId,
	    int teamId,
	    const char* teamRulesParamName,
	    const char* defaultValue);
	...
	// BEGIN OBJECT Group
	int(CALLING_CONV* getGroups)(int skirmishAIId,
	    int* groupIds,
	    int groupIds_sizeMax); //$ FETCHER:MULTI:IDs:Group:groupIds

	int(CALLING_CONV* Group_getSupportedCommands)(int skirmishAIId,
	    int groupId); //$ FETCHER:MULTI:NUM:SupportedCommand-CommandDescription
	...
	int(CALLING_CONV* Group_SupportedCommand_getParams)(int skirmishAIId,
	    int groupId,
	    int supportedCommandId,
	    const char** params,
	    int params_sizeMax); //$ ARRAY:params
	...
	int(CALLING_CONV* Group_OrderPreview_getParams)(int skirmishAIId,
	    int groupId,
	    float* params,
	    int params_sizeMax); //$ ARRAY:params
	 ...
	 * @see getHeightMap()
	 */
	int(CALLING_CONV* Map_getCornersHeightMap)(int skirmishAIId,
	    float* cornerHeights,
	    int cornerHeights_sizeMax); //$ ARRAY:cornerHeights
	 ...
	 * @see getLosMap()
	 */
	int(CALLING_CONV* Map_getAirLosMap)(int skirmishAIId,
	    int* airLosValues,
	    int airLosValues_sizeMax); //$ ARRAY:airLosValues
	 ...
	 * @see getLosMap()
	 */
	int(CALLING_CONV* Map_getRadarMap)(int skirmishAIId,
	    int* radarValues,
	    int radarValues_sizeMax); //$ ARRAY:radarValues

	/** @see getRadarMap() */
	int(CALLING_CONV* Map_getSonarMap)(int skirmishAIId,
	    int* sonarValues,
	    int sonarValues_sizeMax); //$ ARRAY:sonarValues

	/** @see getRadarMap() */
	int(CALLING_CONV* Map_getSeismicMap)(int skirmishAIId,
	    int* seismicValues,
	    int seismicValues_sizeMax); //$ ARRAY:seismicValues

	/** @see getRadarMap() */
	int(CALLING_CONV* Map_getJammerMap)(int skirmishAIId,
	    int* jammerValues,
	    int jammerValues_sizeMax); //$ ARRAY:jammerValues

	/** @see getRadarMap() */
	int(CALLING_CONV* Map_getSonarJammerMap)(int skirmishAIId,
	    int* sonarJammerValues,
	    int sonarJammerValues_sizeMax); //$ ARRAY:sonarJammerValues
	 ...
	 * - the last value, bottom right, is at index (width/2 * height/2 - 1)
	 */
	int(CALLING_CONV* Map_getResourceMapRaw)(int skirmishAIId,
	    int resourceId,
	    short* resources,
	    int resources_sizeMax); //$ REF:resourceId->Resource ARRAY:resources
	 ...
	 */
	int(CALLING_CONV* Map_getResourceMapSpotsPositions)(int skirmishAIId,
	    int resourceId,
	    float* spots_AposF3,
	    int spots_AposF3_sizeMax); //$ REF:resourceId->Resource ARRAY:spots_AposF3

	/**
	 * Returns the average resource income for an extractor on one of the evaluated positions.
	 */
	float(CALLING_CONV* Map_getResourceMapSpotsAverageIncome)(int skirmishAIId,
	    int resourceId); //$ REF:resourceId->Resource

	/**
	 * Returns the nearest resource extractor spot to a specified position out of the evaluated list.
	 */
	void(CALLING_CONV* Map_getResourceMapSpotsNearest)(int skirmishAIId,
	    int resourceId,
	    float* pos_posF3,
	    float* return_posF3_out); //$ REF:resourceId->Resource
	 ...
	 * @see getHardness()
	 */
	int(CALLING_CONV* Map_getHardnessModMap)(int skirmishAIId,
	    float* hardMods,
	    int hardMods_sizeMax); //$ ARRAY:hardMods
	 ...
	 */
	int(CALLING_CONV* Map_getSpeedModMap)(int skirmishAIId,
	    int speedModClass,
	    float* speedMods,
	    int speedMods_sizeMax); //$ ARRAY:speedMods
	...
	bool(CALLING_CONV* Map_isPossibleToBuildAt)(int skirmishAIId,
	    int unitDefId,
	    float* pos_posF3,
	    int facing); //$ REF:unitDefId->UnitDef
	 ...
	 */
	void(CALLING_CONV* Map_findClosestBuildSite)(int skirmishAIId,
	    int unitDefId,
	    float* pos_posF3,
	    float searchRadius,
	    int minDist,
	    int facing,
	    float* return_posF3_out); //$ REF:unitDefId->UnitDef

	// BEGIN OBJECT Map


	// BEGIN OBJECT FeatureDef
	int(CALLING_CONV* getFeatureDefs)(int skirmishAIId,
	    int* featureDefIds,
	    int featureDefIds_sizeMax); //$ FETCHER:MULTI:IDs:FeatureDef:featureDefIds
	...
	float(CALLING_CONV* FeatureDef_getContainedResource)(int skirmishAIId,
	    int featureDefId,
	    int resourceId); //$ REF:resourceId->Resource
	...
	int(CALLING_CONV* FeatureDef_getCustomParams)(int skirmishAIId,
	    int featureDefId,
	    const char** keys,
	    const char** values); //$ MAP
	 ...
	 */
	int(CALLING_CONV* getFeatures)(int skirmishAIId,
	    int* featureIds,
	    int featureIds_sizeMax); //$ REF:MULTI:featureIds->Feature

	/**
	 * Returns all features in a specified area that are currently in LOS,
	 * or all features in this area if cheating is enabled.
	 */
	int(CALLING_CONV* getFeaturesIn)(int skirmishAIId,
	    float* pos_posF3,
	    float radius,
	    bool spherical,
	    int* featureIds,
	 ...
	 * @return float value of parameter if it's set, defaultValue otherwise.
	 */
	float(CALLING_CONV* Feature_getRulesParamFloat)(int skirmishAIId,
	    int unitId,
	    const char* featureRulesParamName,
	    float defaultValue);

	/**
	 * @return string value of parameter if it's set, defaultValue otherwise.
	 */
	const char*(CALLING_CONV* Feature_getRulesParamString)(int skirmishAIId,
	    int unitId,
	    const char* featureRulesParamName,
	    const char* defaultValue);
	...
	int(CALLING_CONV* WeaponDef_Damage_getTypes)(int skirmishAIId,
	    int weaponDefId,
	    float* types,
	    int types_sizeMax); //$ ARRAY:types
	...
	float(CALLING_CONV* WeaponDef_getCost)(int skirmishAIId,
	    int weaponDefId,
	    int resourceId); //$ REF:resourceId->Resource
	 ...
	 */
	float(CALLING_CONV* WeaponDef_Shield_getResourceUse)(int skirmishAIId,
	    int weaponDefId,
	    int resourceId); //$ REF:resourceId->Resource
	 ...
	 */
	float(CALLING_CONV* WeaponDef_Shield_getPowerRegenResource)(int skirmishAIId,
	    int weaponDefId,
	    int resourceId); //$ REF:resourceId->Resource
	...
	int(CALLING_CONV* WeaponDef_getCustomParams)(int skirmishAIId,
	    int weaponDefId,
	    const char** keys,
	    const char** values); //$ MAP
