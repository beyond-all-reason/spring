...
template<typename ValueType> struct X87DenormalSquasher {
	...
	inline X87DenormalSquasher(const X87DenormalSquasher<float>& f)
	    : value(f.value)
	{
		X87DenormalSquashFunction<ValueType>(value);
	}

	inline X87DenormalSquasher(const X87DenormalSquasher<double>& f)
	    : value(f.value)
	{
		X87DenormalSquashFunction<ValueType>(value);
	}

	inline X87DenormalSquasher(const X87DenormalSquasher<long double>& f)
	    : value(f.value)
	{
		X87DenormalSquashFunction<ValueType>(value);
	}
...
#define STREFLOP_X87DENORMAL_NATIVE_FLOAT_OPS(native_type)                                                     \
	inline X87DenormalSquasher(const native_type f)                                                            \
	{                                                                                                          \
		value = f;                                                                                             \
		X87DenormalSquashFunction<ValueType>(value);                                                           \
	}                                                                                                          \
	inline X87DenormalSquasher& operator=(const native_type f)                                                 \
	{                                                                                                          \
		value = f;                                                                                             \
		X87DenormalSquashFunction<ValueType>(value);                                                           \
		return *this;                                                                                          \
...
#define STREFLOP_X87DENORMAL_NATIVE_INT_OPS(native_type)                            \
	...
	inline X87DenormalSquasher& operator=(const native_type x)                      \
	{                                                                               \
		value = x;                                                                  \
		return *this;                                                               \
	}                                                                               \
...
inline X87DenormalSquasher<ValueType> operator+(const X87DenormalSquasher<ValueType>& f1,
    const X87DenormalSquasher<ValueType>& f2)
{
...
#define STREFLOP_X87DENORMAL_FLOAT_BINARY(native_type)                                                              \
	template<typename ValueType>                                                                                    \
	inline X87DenormalSquasher<ValueType> operator+(const X87DenormalSquasher<ValueType>& f1, const native_type f2) \
	{                                                                                                               \
		return f1 + X87DenormalSquasher<ValueType>(f2);                                                             \
	}                                                                                                               \
	template<typename ValueType>                                                                                    \
	inline X87DenormalSquasher<ValueType> operator-(const X87DenormalSquasher<ValueType>& f1, const native_type f2) \
	{                                                                                                               \
	...
	template<typename ValueType>                                                                                    \
	inline X87DenormalSquasher<ValueType> operator+(const native_type f1, const X87DenormalSquasher<ValueType>& f2) \
	{                                                                                                               \
		return X87DenormalSquasher<ValueType>(f1) + f2;                                                             \
	}                                                                                                               \
	template<typename ValueType>                                                                                    \
	inline X87DenormalSquasher<ValueType> operator-(const native_type f1, const X87DenormalSquasher<ValueType>& f2) \
	{                                                                                                               \
	...
	template<typename ValueType>                                                                                    \
	inline bool operator==(const native_type value, const X87DenormalSquasher<ValueType>& f)                        \
	{                                                                                                               \
		return X87DenormalSquasher<ValueType>(value) == f;                                                          \
	}                                                                                                               \
	template<typename ValueType>                                                                                    \
	inline bool operator!=(const native_type value, const X87DenormalSquasher<ValueType>& f)                        \
	{                                                                                                               \
...
#define STREFLOP_X87DENORMAL_INT_BINARY(native_type)                                                                \
	...
	inline X87DenormalSquasher<ValueType> operator+(const X87DenormalSquasher<ValueType>& f1, const native_type f2) \
	{                                                                                                               \
		return X87DenormalSquasher<ValueType>(f1.value + f2);                                                       \
	}                                                                                                               \
	template<typename ValueType>                                                                                    \
	inline X87DenormalSquasher<ValueType> operator-(const X87DenormalSquasher<ValueType>& f1, const native_type f2) \
	{                                                                                                               \
	...
	inline X87DenormalSquasher<ValueType> operator+(const native_type f1, const X87DenormalSquasher<ValueType>& f2) \
	{                                                                                                               \
		return X87DenormalSquasher<ValueType>(f1 + f2.value);                                                       \
	}                                                                                                               \
	template<typename ValueType>                                                                                    \
	inline X87DenormalSquasher<ValueType> operator-(const native_type f1, const X87DenormalSquasher<ValueType>& f2) \
	{                                                                                                               \
