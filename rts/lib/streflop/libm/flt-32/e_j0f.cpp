...
#else
Simple __ieee754_j0f(x) Simple x;
#endif
{
...
#else
Simple __ieee754_y0f(x) Simple x;
#endif
{
...
#else
static Simple pzerof(x) Simple x;
#endif
{
#ifdef __STDC__
	const Simple *p, *q;
...
#else
static Simple qzerof(x) Simple x;
#endif
{
#ifdef __STDC__
	const Simple *p, *q;
