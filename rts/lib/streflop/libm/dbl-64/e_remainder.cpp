...
/*  FUNCTION: uremainder                                                  */
/*                                                                        */
/* An ultimate remainder routine. Given two IEEE StreflopDouble machine numbers x */
...
StreflopDouble __ieee754_remainder(StreflopDouble x, StreflopDouble y)
{
  StreflopDouble z,d,xx;
#if 0
  StreflopDouble yy;
#endif
