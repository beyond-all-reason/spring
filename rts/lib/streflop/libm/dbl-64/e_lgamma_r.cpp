...
#ifdef __STDC__
	static StreflopDouble sin_pi(StreflopDouble x)
#else
	static StreflopDouble sin_pi(x)
	StreflopDouble x;
#endif
{
	StreflopDouble y,z;
...
#ifdef __STDC__
	StreflopDouble __ieee754_lgamma_r(StreflopDouble x, int *signgamp)
#else
	StreflopDouble __ieee754_lgamma_r(x,signgamp)
	StreflopDouble x; int *signgamp;
#endif
{
	StreflopDouble t,y,z,nadj,p,p1,p2,p3,q,r,w;
	int i,hx,lx,ix;
