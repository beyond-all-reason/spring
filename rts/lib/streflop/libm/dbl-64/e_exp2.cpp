...
/* StreflopDouble-precision floating point 2^x.
...
static const StreflopDouble TWO1023 = 8.988465674311579539e+307;
static const StreflopDouble TWOM1000 = 9.3326361850321887899e-302;

namespace streflop_libm {
StreflopDouble
__ieee754_exp2 (StreflopDouble x)
{
  static const StreflopDouble himark = (StreflopDouble) DBL_MAX_EXP;
  static const StreflopDouble lomark = (StreflopDouble) (DBL_MIN_EXP - DBL_MANT_DIG - 1);

  /* Check for usual case.  */
  if (isless (x, himark) && isgreaterequal (x, lomark))
    {
      static const StreflopDouble THREEp42 = 13194139533312.0;
      int tval, unsafe;
      StreflopDouble rx, x22, result;
