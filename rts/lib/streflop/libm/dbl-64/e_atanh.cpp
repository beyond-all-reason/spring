...
#ifdef __STDC__
static const StreflopDouble one = 1.0, huge = 1e300;
#else
static StreflopDouble one = 1.0, huge = 1e300;
#endif
...
#ifdef __STDC__
	StreflopDouble __ieee754_atanh(StreflopDouble x)
#else
	StreflopDouble __ieee754_atanh(x)
	StreflopDouble x;
#endif
{
	StreflopDouble t;
