...
#define UMATH_LIB
/********************************************************************/
/* Function changes the precision mode to IEEE 754 StreflopDouble precision */
...
/* a NaN.                                                           */
StreflopDouble uasin(StreflopDouble );
...
StreflopDouble upow(StreflopDouble , StreflopDouble );

/* Computing x mod y, where x is the left argument and y is the     */
/* right one.                                                       */
StreflopDouble uremainder(StreflopDouble , StreflopDouble );
