...
/*                uatan.tbl                                             */
/*                                                                      */
/* An ultimate atan() routine. Given an IEEE StreflopDouble machine number x    */
...
static StreflopDouble atanMp(StreflopDouble,const int[]);
StreflopDouble __signArctan(StreflopDouble,StreflopDouble);
/* An ultimate atan() routine. Given an IEEE StreflopDouble machine number x,    */
/* routine computes the correctly rounded (to nearest) value of atan(x). */
StreflopDouble atan(StreflopDouble x) {


  StreflopDouble cor,s1,ss1,s2,ss2,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,u,u2,u3,
         v,vv,w,ww,y,yy,z,zz;
#if 0
  StreflopDouble y1,y2;
#endif
  int i,ux,dx;
#if 0
  int p;
...
StreflopDouble  __signArctan(StreflopDouble x,StreflopDouble y){
...
static StreflopDouble atanMp(StreflopDouble x,const int pr[]){
