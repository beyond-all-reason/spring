...
StreflopDouble fastiroot(StreflopDouble);
...
/***********************************************************/
/* Compute a StreflopDouble precision approximation for 1/sqrt(x)  */
/* with the relative error bounded by 2**-51.              */
/***********************************************************/
StreflopDouble fastiroot(StreflopDouble x) {
  struct {
...
int i[2];} p,q;
  StreflopDouble y,z, t;
  int n;
  static const StreflopDouble c0 = 0.99674, c1 = -0.53380, c2 = 0.45472, c3 = -0.21553;
