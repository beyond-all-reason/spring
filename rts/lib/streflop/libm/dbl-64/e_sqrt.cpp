...
/*               uroot.tbl                                           */
/*                                                                   */
/* An ultimate sqrt routine. Given an IEEE StreflopDouble machine number x   */
...
#include "uroot.h"
  ...
  static const StreflopDouble big =  134217728.0;
  StreflopDouble y,t,del,res,res1,hy,z,zz,p,hx,tx,ty,s;
  mynumber a,c={{0,0}};
  int4 k;
