...
void __mp_dbl(const mp_no *, StreflopDouble *, int);
void __dbl_mp(StreflopDouble, mp_no *, int);
...
extern int __mpranred (StreflopDouble, mp_no *, int);
}
