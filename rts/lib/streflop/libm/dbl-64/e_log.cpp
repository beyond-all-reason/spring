...
/*                    ulog.tbl                                       */
/*                                                                   */
/* An ultimate log routine. Given an IEEE StreflopDouble machine number x    */
...
/* it computes the correctly rounded (to nearest) value of log(x).   */
/*********************************************************************/
StreflopDouble __ieee754_log(StreflopDouble x) {
#define M 4
  ...
  int k;
#endif
  StreflopDouble dbl_n,u,p0,q,r0,w,nln2a,luai,lubi,lvaj,lvbj,
...
#include "ulog.h"
  ...
  u = num.d();  dbl_n = (StreflopDouble) n;
