...
/*                                                                         */
/* An ultimate exp routine. Given an IEEE StreflopDouble machine number x          */
...
StreflopDouble __slowexp(StreflopDouble);
...
StreflopDouble __ieee754_exp(StreflopDouble x) {
  StreflopDouble bexp, t, eps, del, base, y, al, bet, res, rem, cor;
...
/************************************************************************/
/* Compute e^(x+xx)(StreflopDouble-Length number) .The routine also receive     */
