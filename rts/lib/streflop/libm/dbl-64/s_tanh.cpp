...
#ifdef __STDC__
static const StreflopDouble one=1.0, two=2.0, tiny = 1.0e-300;
#else
static StreflopDouble one=1.0, two=2.0, tiny = 1.0e-300;
#endif

#ifdef __STDC__
	StreflopDouble __tanh(StreflopDouble x)
#else
	StreflopDouble __tanh(x)
	StreflopDouble x;
#endif
{
	StreflopDouble t,z;
