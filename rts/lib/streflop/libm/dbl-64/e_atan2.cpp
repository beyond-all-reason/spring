...
/*                uatan.tbl                                             */
/*                                                                      */
/* An ultimate atan2() routine. Given two IEEE StreflopDouble machine numbers y,*/
...
/************************************************************************/
/* An ultimate atan2 routine. Given two IEEE StreflopDouble machine numbers y,x */
/* it computes the correctly rounded (to nearest) value of atan2(y,x).  */
/* Assumption: Machine arithmetic operations are performed in           */
/* round to nearest mode of IEEE 754 standard.                          */
/************************************************************************/
namespace streflop_libm {
static StreflopDouble atan2Mp(StreflopDouble ,StreflopDouble ,const int[]);
static StreflopDouble signArctan2(StreflopDouble ,StreflopDouble);
static StreflopDouble normalized(StreflopDouble ,StreflopDouble,StreflopDouble ,StreflopDouble);
void __mpatan2(mp_no *,mp_no *,mp_no *,int);

StreflopDouble __ieee754_atan2(StreflopDouble y,StreflopDouble x) {
  ...
  StreflopDouble ax,ay,u,du,u9,ua,v,vv,dv,t1,t2,t3,t4,t5,t6,t7,t8,
         z,zz,cor,s1,ss1,s2,ss2;
#if 0
  StreflopDouble z1,z2;
#endif
  number num;
#if 0
...
static StreflopDouble  normalized(StreflopDouble ax,StreflopDouble ay,StreflopDouble y, StreflopDouble z)
    { int p;
...
static StreflopDouble signArctan2(StreflopDouble y,StreflopDouble z)
{
  return ((y<ZERO) ? -z : z);
}
  /* Stage 3: Perform a multi-Precision computation */
static StreflopDouble  atan2Mp(StreflopDouble x,StreflopDouble y,const int pr[])
{
  StreflopDouble z1,z2;
  int i,p;
