...
/*               sincos.tbl                                                 */
/*                                                                          */
/* An ultimate sin and  routine. Given an IEEE StreflopDouble machine number x       */
...
void __dubsin(StreflopDouble x, StreflopDouble dx, StreflopDouble w[]);
void __docos(StreflopDouble x, StreflopDouble dx, StreflopDouble w[]);
StreflopDouble __mpsin(StreflopDouble x, StreflopDouble dx);
StreflopDouble __mpcos(StreflopDouble x, StreflopDouble dx);
StreflopDouble __mpsin1(StreflopDouble x);
StreflopDouble __mpcos1(StreflopDouble x);
namespace streflop_libm {
static StreflopDouble slow(StreflopDouble x);
static StreflopDouble slow1(StreflopDouble x);
static StreflopDouble slow2(StreflopDouble x);
static StreflopDouble sloww(StreflopDouble x, StreflopDouble dx, StreflopDouble orig);
static StreflopDouble sloww1(StreflopDouble x, StreflopDouble dx, StreflopDouble orig);
static StreflopDouble sloww2(StreflopDouble x, StreflopDouble dx, StreflopDouble orig, int n);
static StreflopDouble bsloww(StreflopDouble x, StreflopDouble dx, StreflopDouble orig, int n);
static StreflopDouble bsloww1(StreflopDouble x, StreflopDouble dx, StreflopDouble orig, int n);
static StreflopDouble bsloww2(StreflopDouble x, StreflopDouble dx, StreflopDouble orig, int n);
int __branred(StreflopDouble x, StreflopDouble *a, StreflopDouble *aa);
static StreflopDouble cslow2(StreflopDouble x);
static StreflopDouble csloww(StreflopDouble x, StreflopDouble dx, StreflopDouble orig);
static StreflopDouble csloww1(StreflopDouble x, StreflopDouble dx, StreflopDouble orig);
static StreflopDouble csloww2(StreflopDouble x, StreflopDouble dx, StreflopDouble orig, int n);
/*******************************************************************/
/* An ultimate sin routine. Given an IEEE StreflopDouble machine number x   */
/* it computes the correctly rounded (to nearest) value of sin(x)  */
/*******************************************************************/
StreflopDouble __sin(StreflopDouble x){
	StreflopDouble xx,res,t,cor,y,s,c,sn,ssn,cs,ccs,xn,a,da,db,eps,xn1,xn2;
#if 0
	StreflopDouble w[2];
#endif
	mynumber u,v;
...
/*******************************************************************/
/* An ultimate cos routine. Given an IEEE StreflopDouble machine number x   */
/* it computes the correctly rounded (to nearest) value of cos(x)  */
/*******************************************************************/

StreflopDouble __cos(StreflopDouble x)
{
  StreflopDouble y,xx,res,t,cor,s,c,sn,ssn,cs,ccs,xn,a,da,db,eps,xn1,xn2;
  mynumber u,v;
  int4 k,m,n;
...
static StreflopDouble slow(StreflopDouble x) {
static const StreflopDouble th2_36 = 206158430208.0;   /*    1.5*2**37   */
 StreflopDouble y,x1,x2,xx,r,t,res,cor,w[2];
 x1=(x+th2_36)-th2_36;
 y = aa.x()*x1*x1*x1;
 r=x+y;
 x2=x-x1;
...
static StreflopDouble slow1(StreflopDouble x) {
  mynumber u;
  StreflopDouble sn,ssn,cs,ccs,s,c,w[2],y,y1,y2,c1,c2,xx,cor,res;
  static const StreflopDouble t22 = 6291456.0;
  int4 k;
  y=ABS(x);
  u.x()=big.x()+y;
  y=y-(u.x()-big.x());
...
static StreflopDouble slow2(StreflopDouble x) {
  mynumber u;
  StreflopDouble sn,ssn,cs,ccs,s,c,w[2],y,y1,y2,e1,e2,xx,cor,res,del;
  static const StreflopDouble t22 = 6291456.0;
  int4 k;
  y=ABS(x);
  y = hp0.x()-y;
...
/***************************************************************************/
/*  Routine compute sin(x+dx) (StreflopDouble-Length number) where x is small enough*/
...
static StreflopDouble sloww(StreflopDouble x,StreflopDouble dx, StreflopDouble orig) {
  static const StreflopDouble th2_36 = 206158430208.0;   /*    1.5*2**37   */
  StreflopDouble y,x1,x2,xx,r,t,res,cor,w[2],a,da,xn;
  struct {
...
/***************************************************************************/
/*  Routine compute sin(x+dx)   (StreflopDouble-Length number) where x in first or  */
...
/***************************************************************************/
/*  Routine compute sin(x+dx)   (StreflopDouble-Length number) where x in second or */
...
static StreflopDouble sloww2(StreflopDouble x, StreflopDouble dx, StreflopDouble orig, int n) {
  mynumber u;
  StreflopDouble sn,ssn,cs,ccs,s,c,w[2],y,y1,y2,e1,e2,xx,cor,res;
  static const StreflopDouble t22 = 6291456.0;
  int4 k;
  y=ABS(x);
  u.x()=big.x()+y;
...
/***************************************************************************/
/*  Routine compute sin(x+dx) or cos(x+dx) (StreflopDouble-Length number) where x   */
...
/***************************************************************************/
/*  Routine compute cos(x+dx) (StreflopDouble-Length number) where x is small enough*/
