...
/*               utan.tbl                                            */
/*                                                                   */
/* An ultimate tan routine. Given an IEEE StreflopDouble machine number x    */
...
static StreflopDouble tanMp(StreflopDouble);
void __mptan(StreflopDouble, mp_no *, int);
...
#include "utan.tbl"
  ...
  int ux,i,n;
  StreflopDouble a,da,a2,b,db,c,dc,c1,cc1,c2,cc2,c3,cc3,fi,ffi,gi,pz,s,sy,
  ...
  int __branred(StreflopDouble, StreflopDouble *, StreflopDouble *);
  int __mpranred(StreflopDouble, mp_no *, int);
...
/* and converts result back to StreflopDouble                                    */
static StreflopDouble tanMp(StreflopDouble x)
{
  int p;
  StreflopDouble y;
  mp_no mpy;
