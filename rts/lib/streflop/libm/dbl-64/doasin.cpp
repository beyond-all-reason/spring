...
/*              mpa.c                                                 */
/*                                                                    */
/* Compute arcsin(x,dx,v) of StreflopDouble-length number (x+dx) the result   */
...
void __doasin(StreflopDouble x, StreflopDouble dx, StreflopDouble v[]) {
...
#include "doasin.h"
  ...
  StreflopDouble xx,p,pp,u,uu,r,s;
  StreflopDouble hx,tx,hy,ty,tp,tq,tc,tcc;


/* Taylor series for arcsin for StreflopDouble-Length numbers         */
  xx = x*x+2.0*x*dx;
