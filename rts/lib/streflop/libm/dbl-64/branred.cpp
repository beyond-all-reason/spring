...
/*               mha.c                                             */
/*                                                                 */
/* Routine  branred() performs range  reduction of a StreflopDouble number */
/* x into StreflopDouble length number  a+aa,such that                     */
...
int __branred(StreflopDouble x, StreflopDouble *a, StreflopDouble *aa)
{
  ...
  mynumber v;
#endif
  StreflopDouble r[6],s,t,sum,b,bb,sum1,sum2,b1,bb1,b2,bb2,x1,x2,t1,t2;
