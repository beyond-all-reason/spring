...
/* a StreflopDouble number x into multi precision number   y,           */
...
/************************************************************************/
/*Routine receive StreflopDouble x and two StreflopDouble results of sin(x) and return  */
...
/************************************************************************/
/*Routine receive StreflopDouble x and two StreflopDouble results of cos(x) and return  */
/*result which is more accurate                                         */
...
/*******************************************************************/
/* Compute cos()of StreflopDouble-length number (x+dx) as Multi Precision  */
/* number and return result as StreflopDouble                              */
/*******************************************************************/
