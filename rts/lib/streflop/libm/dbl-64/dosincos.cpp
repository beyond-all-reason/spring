...
/*               sincos.tbl                                         */
/*                                                                  */
/* Routines compute sin() and cos() as StreflopDouble-Length numbers         */
/********************************************************************/
...
/***********************************************************************/
/* Routine receive StreflopDouble-Length number (x+dx) and computing sin(x+dx) */
/* as StreflopDouble-Length number and store it at array v .It computes it by  */
/* arithmetic action on StreflopDouble-Length numbers                          */
/*(x+dx) between 0 and PI/4                                            */
/***********************************************************************/

namespace streflop_libm {
void __dubsin(StreflopDouble x, StreflopDouble dx, StreflopDouble v[]) {
  StreflopDouble r,s,p,hx,tx,hy,ty,q,c,cc,d,dd,d2,dd2,e,ee,
    sn,ssn,cs,ccs,ds,dss,dc,dcc;
#if 0
  StreflopDouble xx,y,yy,z,zz;
#endif
  mynumber u;
  int4 k;
...
/**********************************************************************/
/* Routine receive StreflopDouble-Length number (x+dx) and computes cos(x+dx) */
/* as StreflopDouble-Length number and store it in array v .It computes it by */
/* arithmetic action on StreflopDouble-Length numbers                         */
/*(x+dx) between 0 and PI/4                                           */
/**********************************************************************/
...
/**********************************************************************/
/* Routine receive StreflopDouble-Length number (x+dx) and computes cos(x+dx) */
/* as StreflopDouble-Length number and store it in array v                    */
/**********************************************************************/
void __docos(StreflopDouble x, StreflopDouble dx, StreflopDouble v[]) {
  StreflopDouble y,yy,p,w[2];
  if (x>0) {y=x; yy=dx;}
     else {y=-x; yy=-dx;}
