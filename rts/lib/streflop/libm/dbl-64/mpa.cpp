...
/* Convert a multiple precision number *x into a StreflopDouble precision */
/* number *y, normalized case  (|x| >= 2**(-1022))) */
static void norm(const mp_no *x, StreflopDouble *y, int p)
{
  #define R  radixi.d()
  int i;
#if 0
...
static void denorm(const mp_no *x, StreflopDouble *y, int p)
{
  int i,k;
  StreflopDouble c,u,z[5];
#if 0
  StreflopDouble a,v;
#endif
...
/* Convert a multiple precision number *x into a StreflopDouble precision number *y. */
/* The result is correctly rounded to the nearest/even. *x is left unchanged */

void __mp_dbl(const mp_no *x, StreflopDouble *y, int p) {
#if 0
  int i,k;
  StreflopDouble a,c,u,v,z[5];
#endif
...
/* dbl_mp() converts a StreflopDouble precision number x into a multiple precision  */
/* number *y. If the precision p is too small the result is truncated. x is */
/* left unchanged.                                                          */

void __dbl_mp(StreflopDouble x, mp_no *y, int p) {
