...
/* reduction of a StreflopDouble number x into a multiple precision number    */
...
void __mptan(StreflopDouble x, mp_no *mpy, int p) {

  static const StreflopDouble MONE = -1.0;
