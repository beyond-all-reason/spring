...
template<>
SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator+=(const SoftFloatWrapper<N_SPECIALIZED>& f)
{
...
template<typename T> struct IntConverter<N_SPECIALIZED, T, true> {
	static inline SF_TYPE convert_from_int(T an_int) { return SF_APPEND(int64_to_)((int64_t)an_int); }

	static inline T convert_to_int(SF_TYPE value) { return (T)SF_PREPEND(_to_int64_round_to_zero)(value); }
};

// Specialization for ints <= 32 bits
template<typename T> struct IntConverter<N_SPECIALIZED, T, false> {
	static inline SF_TYPE convert_from_int(T an_int) { return SF_APPEND(int32_to_)((int32_t)an_int); }

	static inline T convert_to_int(SF_TYPE value) { return (T)SF_PREPEND(_to_int32_round_to_zero)(value); }
};
...
#define STREFLOP_X87DENORMAL_NATIVE_OPS_INT(native_type)                                                              \
	...
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator+=(const native_type f)      \
	{                                                                                                                 \
		value<SF_TYPE>() = SF_PREPEND(_add)(value<SF_TYPE>(),                                                         \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
		return *this;                                                                                                 \
	}                                                                                                                 \
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator-=(const native_type f)      \
	{                                                                                                                 \
		value<SF_TYPE>() = SF_PREPEND(_sub)(value<SF_TYPE>(),                                                         \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
		return *this;                                                                                                 \
	}                                                                                                                 \
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator*=(const native_type f)      \
	{                                                                                                                 \
		value<SF_TYPE>() = SF_PREPEND(_mul)(value<SF_TYPE>(),                                                         \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
		return *this;                                                                                                 \
	}                                                                                                                 \
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator/=(const native_type f)      \
	{                                                                                                                 \
		value<SF_TYPE>() = SF_PREPEND(_div)(value<SF_TYPE>(),                                                         \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
		return *this;                                                                                                 \
	}                                                                                                                 \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator==(const native_type f) const                            \
	{                                                                                                                 \
		return SF_PREPEND(_eq)(value<SF_TYPE>(),                                                                      \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
	}                                                                                                                 \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator!=(const native_type f) const                            \
	{                                                                                                                 \
	...
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator<(const native_type f) const                             \
	{                                                                                                                 \
		return SF_PREPEND(_lt)(value<SF_TYPE>(),                                                                      \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
	}                                                                                                                 \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator<=(const native_type f) const                            \
	{                                                                                                                 \
		return SF_PREPEND(_le)(value<SF_TYPE>(),                                                                      \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f));                \
	}                                                                                                                 \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator>(const native_type f) const                             \
	{                                                                                                                 \
		return SF_PREPEND(_lt)(                                                                                       \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f),                 \
		    value<SF_TYPE>());                                                                                        \
	}                                                                                                                 \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator>=(const native_type f) const                            \
	{                                                                                                                 \
		return SF_PREPEND(_le)(                                                                                       \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f),                 \
		    value<SF_TYPE>());                                                                                        \
	}
...
template<> struct FloatConverter<N_SPECIALIZED, float, 4> {
	static inline SF_TYPE convert_from_float(const float a_float)
	{
...
template<> struct FloatConverter<N_SPECIALIZED, double, 8> {
	static inline SF_TYPE convert_from_float(const double a_float)
	{
...
// Little endian OK: both address are the same
	...
	static inline SF_TYPE convert_from_float(const long double a_float)
	{
...
// Specialization for floatx80 when C long double type size is 16. This is the case for g++ using -m128bit-long-double,
// which is itself the default on x86_64
...
#define STREFLOP_X87DENORMAL_NATIVE_OPS_FLOAT(native_type)                                                             \
	...
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator+=(const native_type f)       \
	{                                                                                                                  \
		value<SF_TYPE>() = SF_PREPEND(_add)(                                                                           \
		    value<SF_TYPE>(), FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f)); \
		return *this;                                                                                                  \
	}                                                                                                                  \
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator-=(const native_type f)       \
	{                                                                                                                  \
		value<SF_TYPE>() = SF_PREPEND(_sub)(                                                                           \
		    value<SF_TYPE>(), FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f)); \
		return *this;                                                                                                  \
	}                                                                                                                  \
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator*=(const native_type f)       \
	{                                                                                                                  \
		value<SF_TYPE>() = SF_PREPEND(_mul)(                                                                           \
		    value<SF_TYPE>(), FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f)); \
		return *this;                                                                                                  \
	}                                                                                                                  \
	template<> SoftFloatWrapper<N_SPECIALIZED>& SoftFloatWrapper<N_SPECIALIZED>::operator/=(const native_type f)       \
	{                                                                                                                  \
		value<SF_TYPE>() = SF_PREPEND(_div)(                                                                           \
		    value<SF_TYPE>(), FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f)); \
		return *this;                                                                                                  \
	}                                                                                                                  \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator==(const native_type f) const                             \
	{                                                                                                                  \
		return SF_PREPEND(_eq)(                                                                                        \
		    value<SF_TYPE>(), FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f)); \
	}                                                                                                                  \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator!=(const native_type f) const                             \
	{                                                                                                                  \
	...
	{                                                                                                                  \
		return SF_PREPEND(_lt)(                                                                                        \
		    FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f), value<SF_TYPE>()); \
	}                                                                                                                  \
	template<> bool SoftFloatWrapper<N_SPECIALIZED>::operator>=(const native_type f) const                             \
	{                                                                                                                  \
		return SF_PREPEND(_le)(                                                                                        \
...
template<>
SoftFloatWrapper<N_SPECIALIZED> operator+(const SoftFloatWrapper<N_SPECIALIZED>& f1,
    const SoftFloatWrapper<N_SPECIALIZED>& f2)
{
...
#define STREFLOP_X87DENORMAL_BINARY_OPS_INT(native_type)                                                       \
	template<>                                                                                                 \
	SoftFloatWrapper<N_SPECIALIZED> operator+(const SoftFloatWrapper<N_SPECIALIZED>& f1, const native_type f2) \
	{                                                                                                          \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                \
		    SF_PREPEND(_add)(f1.value<SF_TYPE>(),                                                              \
		        IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f2)),    \
		    true);                                                                                             \
	}                                                                                                          \
	template<>                                                                                                 \
	SoftFloatWrapper<N_SPECIALIZED> operator-(const SoftFloatWrapper<N_SPECIALIZED>& f1, const native_type f2) \
	{                                                                                                          \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                \
		    SF_PREPEND(_sub)(f1.value<SF_TYPE>(),                                                              \
		        IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f2)),    \
		    true);                                                                                             \
	}                                                                                                          \
	template<>                                                                                                 \
	...
	{                                                                                                          \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                \
		    SF_PREPEND(_mul)(f1.value<SF_TYPE>(),                                                              \
		        IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f2)),    \
		    true);                                                                                             \
	}                                                                                                          \
	template<>                                                                                                 \
	...
	{                                                                                                          \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                \
		    SF_PREPEND(_div)(f1.value<SF_TYPE>(),                                                              \
		        IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f2)),    \
		    true);                                                                                             \
	}                                                                                                          \
	template<>                                                                                                 \
	SoftFloatWrapper<N_SPECIALIZED> operator+(const native_type f1, const SoftFloatWrapper<N_SPECIALIZED>& f2) \
	{                                                                                                          \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                \
		    SF_PREPEND(_add)(                                                                                  \
		        IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(f1),     \
		        f2.value<SF_TYPE>()),                                                                          \
		    true);                                                                                             \
	}                                                                                                          \
	template<>                                                                                                 \
	...
	{                                                                                                          \
		return SF_PREPEND(_eq)(                                                                                \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(value),      \
		    f.value<SF_TYPE>());                                                                               \
	}                                                                                                          \
	template<> bool operator!=(const native_type value, const SoftFloatWrapper<N_SPECIALIZED>& f)              \
	{                                                                                                          \
	...
	template<> bool operator>(const native_type value, const SoftFloatWrapper<N_SPECIALIZED>& f)               \
	{                                                                                                          \
		return SF_PREPEND(_lt)(f.value<SF_TYPE>(),                                                             \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(value));     \
	}                                                                                                          \
	template<> bool operator>=(const native_type value, const SoftFloatWrapper<N_SPECIALIZED>& f)              \
	{                                                                                                          \
		return SF_PREPEND(_le)(f.value<SF_TYPE>(),                                                             \
		    IntConverter<N_SPECIALIZED, native_type, (sizeof(native_type) > 4)>::convert_from_int(value));     \
	}
...
#define STREFLOP_X87DENORMAL_BINARY_OPS_FLOAT(native_type)                                                            \
	...
	{                                                                                                                 \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                       \
		    SF_PREPEND(_add)(f1.value<SF_TYPE>(),                                                                     \
		        FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f2)),             \
		    true);                                                                                                    \
	}                                                                                                                 \
	template<>                                                                                                        \
	SoftFloatWrapper<N_SPECIALIZED> operator-(const SoftFloatWrapper<N_SPECIALIZED>& f1, const native_type f2)        \
	...
	{                                                                                                                 \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                       \
		    SF_PREPEND(_add)(FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f1), \
		        f2.value<SF_TYPE>()),                                                                                 \
		    true);                                                                                                    \
	}                                                                                                                 \
	template<>                                                                                                        \
	...
	{                                                                                                                 \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                       \
		    SF_PREPEND(_sub)(FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f1), \
		        f2.value<SF_TYPE>()),                                                                                 \
		    true);                                                                                                    \
	}                                                                                                                 \
	template<>                                                                                                        \
	...
	{                                                                                                                 \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                       \
		    SF_PREPEND(_mul)(FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f1), \
		        f2.value<SF_TYPE>()),                                                                                 \
		    true);                                                                                                    \
	}                                                                                                                 \
	template<>                                                                                                        \
	...
	{                                                                                                                 \
		return SoftFloatWrapper<N_SPECIALIZED>(                                                                       \
		    SF_PREPEND(_div)(FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(f1), \
		        f2.value<SF_TYPE>()),                                                                                 \
		    true);                                                                                                    \
	}                                                                                                                 \
	template<> bool operator==(const native_type value, const SoftFloatWrapper<N_SPECIALIZED>& f)                     \
	{                                                                                                                 \
		return SF_PREPEND(_eq)(                                                                                       \
		    FloatConverter<N_SPECIALIZED, native_type, sizeof(native_type)>::convert_from_float(value),               \
		    f.value<SF_TYPE>());                                                                                      \
	}                                                                                                                 \
	template<> bool operator!=(const native_type value, const SoftFloatWrapper<N_SPECIALIZED>& f)                     \
	{                                                                                                                 \
