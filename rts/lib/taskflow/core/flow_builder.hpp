...
class FlowBuilder {
  ...
  */
  ...
  @tparam C comparator type
  @tparam size_t cutoff value type

  @param first iterator to the beginning (inclusive)
  @param last iterator to the end (exclusive)
  @param cmp comparison operator
  @param cf defines the cutoff size of part or full container
  to process it in a sequential way
  ...
  */
  ...
  Task sort(B first, E last, C cmp, size_t cf);
