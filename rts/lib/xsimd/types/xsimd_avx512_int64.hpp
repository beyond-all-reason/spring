...
template<> struct simd_batch_traits<batch_bool<int64_t, 8>> {
...
template<> struct simd_batch_traits<batch_bool<uint64_t, 8>> {
...
template<> class batch_bool<int64_t, 8> : public batch_bool_avx512<__mmask8, batch_bool<int64_t, 8>> {
public:
	using base_class = batch_bool_avx512<__mmask8, batch_bool<int64_t, 8>>;
	using base_class::base_class;
};

template<> class batch_bool<uint64_t, 8> : public batch_bool_avx512<__mmask8, batch_bool<uint64_t, 8>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<int64_t, 8> : batch_bool_kernel_avx512<int64_t, 8> {};

template<> struct batch_bool_kernel<uint64_t, 8> : batch_bool_kernel_avx512<uint64_t, 8> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<int64_t, 8>> {
	using value_type = int64_t;
	static constexpr std::size_t size = 8;
...
template<> struct simd_batch_traits<batch<uint64_t, 8>> {
	using value_type = uint64_t;
	static constexpr std::size_t size = 8;
...
template<> class batch<int64_t, 8> : public avx512_int_batch<int64_t, 8> {
public:
...
template<> class batch<uint64_t, 8> : public avx512_int_batch<uint64_t, 8> {
public:
...
namespace detail {
template<class T> struct avx512_int64_batch_kernel : avx512_int_kernel_base<batch<T, 8>> {
	using batch_type = batch<T, 8>;
	using value_type = T;
	using batch_bool_type = batch_bool<T, 8>;

	static batch_type neg(const batch_type& rhs) { return _mm512_sub_epi64(_mm512_setzero_si512(), rhs); }

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm512_add_epi64(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm512_sub_epi64(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm512_mullo_epi64(lhs, rhs); }
	...
	static batch_type bitwise_not(const batch_type& rhs) { return _mm512_xor_si512(rhs, _mm512_set1_epi64(-1)); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpacklo_epi64(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpackhi_epi64(lhs, rhs); }
};

template<> struct batch_kernel<int64_t, 8> : public avx512_int64_batch_kernel<int64_t> {
	using batch_type = batch<int64_t, 8>;
	using value_type = int64_t;
	using batch_bool_type = batch_bool<int64_t, 8>;
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm512_min_epi64(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm512_max_epi64(lhs, rhs); }

	static batch_type abs(const batch_type& rhs) { return _mm512_abs_epi64(rhs); }
};

template<> struct batch_kernel<uint64_t, 8> : public avx512_int64_batch_kernel<uint64_t> {
	using batch_type = batch<uint64_t, 8>;
	using value_type = uint64_t;
	using batch_bool_type = batch_bool<uint64_t, 8>;
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm512_min_epu64(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm512_max_epu64(lhs, rhs); }
