...
template<> struct simd_batch_traits<batch_bool<int64_t, 4>> {
...
template<> struct simd_batch_traits<batch_bool<uint64_t, 4>> {
...
template<> class batch_bool<int64_t, 4> : public avx_int_batch_bool<int64_t, 4> {
public:
	using avx_int_batch_bool::avx_int_batch_bool;
};

template<> class batch_bool<uint64_t, 4> : public avx_int_batch_bool<uint64_t, 4> {
public:
	using avx_int_batch_bool::avx_int_batch_bool;
};

namespace detail {
template<> struct batch_bool_kernel<int64_t, 4> : public avx_int_batch_bool_kernel<int64_t, 4> {};

template<> struct batch_bool_kernel<uint64_t, 4> : public avx_int_batch_bool_kernel<uint64_t, 4> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<int64_t, 4>> {
	using value_type = int64_t;
	static constexpr std::size_t size = 4;
...
template<> struct simd_batch_traits<batch<uint64_t, 4>> {
	using value_type = uint64_t;
	static constexpr std::size_t size = 4;
...
template<> class batch<int64_t, 4> : public avx_int_batch<int64_t, 4> {
public:
...
template<> class batch<uint64_t, 4> : public avx_int_batch<uint64_t, 4> {
public:
...
namespace detail {
template<> struct batch_kernel<uint64_t, 4> : avx_int_kernel_base<batch<uint64_t, 4>> {
	using batch_type = batch<uint64_t, 4>;
	using value_type = uint64_t;
	using batch_bool_type = batch_bool<uint64_t, 4>;
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpacklo_epi64(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpackhi_epi64(lhs, rhs); }
};

template<> struct batch_kernel<int64_t, 4> : avx_int_kernel_base<batch<int64_t, 4>> {
	using batch_type = batch<int64_t, 4>;
	using value_type = int64_t;
	using batch_bool_type = batch_bool<int64_t, 4>;
