...
inline batch<int32_t, 16> to_int(const batch<float, 16>& x) { return _mm512_cvttps_epi32(x); }
...
#else
	return batch<int64_t, 8>(static_cast<int64_t>(x[0]), static_cast<int64_t>(x[1]), static_cast<int64_t>(x[2]),
	    static_cast<int64_t>(x[3]), static_cast<int64_t>(x[4]), static_cast<int64_t>(x[5]), static_cast<int64_t>(x[6]),
	    static_cast<int64_t>(x[7]));
#endif
}

inline batch<float, 16> to_float(const batch<int32_t, 16>& x) { return _mm512_cvtepi32_ps(x); }
...
#else
	return batch<double, 8>(static_cast<double>(x[0]), static_cast<double>(x[1]), static_cast<double>(x[2]),
...
inline batch_bool<int32_t, 16> bool_cast(const batch_bool<float, 16>& x) { return __mmask16(x); }

inline batch_bool<int64_t, 8> bool_cast(const batch_bool<double, 8>& x) { return __mmask8(x); }

inline batch_bool<float, 16> bool_cast(const batch_bool<int32_t, 16>& x) { return __mmask16(x); }

inline batch_bool<double, 8> bool_cast(const batch_bool<int64_t, 8>& x) { return __mmask8(x); }
