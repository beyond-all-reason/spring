...
template<> struct simd_batch_traits<batch<int32_t, 4>> {
...
template<> class batch<int32_t, 4> : public simd_batch<batch<int32_t, 4>> {
public:
	...
	template<class... Args, class Enable = detail::is_array_initializer_t<int32_t, 4, Args...>> batch(Args... args);
...
namespace detail {
inline int32x4_t init_from_bool(uint32x4_t a) { return vandq_s32(reinterpret_cast<int32x4_t>(a), vdupq_n_s32(1)); }
} // namespace detail
...
inline batch<int32_t, 4>& batch<int32_t, 4>::load_unaligned(const int16_t* src) { return load_aligned(src); }
...
inline batch<int32_t, 4>& batch<int32_t, 4>::load_unaligned(const uint16_t* src) { return load_aligned(src); }
...
inline batch<int32_t, 4>& batch<int32_t, 4>::load_unaligned(const int32_t* src) { return load_aligned(src); }
...
inline batch<int32_t, 4>& batch<int32_t, 4>::load_unaligned(const uint32_t* src) { return load_aligned(src); }
...
inline batch<int32_t, 4>& batch<int32_t, 4>::load_aligned(const double* src)
{
	...
	return *this;
#else
	this->m_value = int32x4_t{static_cast<int32_t>(src[0]), static_cast<int32_t>(src[1]), static_cast<int32_t>(src[2]),
	    static_cast<int32_t>(src[3])};
#endif
	return *this;
}

inline batch<int32_t, 4>& batch<int32_t, 4>::load_unaligned(const double* src) { return load_aligned(src); }
...
inline void batch<int32_t, 4>::store_unaligned(int16_t* dst) const { store_aligned(dst); }
...
inline void batch<int32_t, 4>::store_unaligned(uint16_t* dst) const { store_aligned(dst); }

inline void batch<int32_t, 4>::store_aligned(int32_t* dst) const { vst1q_s32(dst, this->m_value); }

inline void batch<int32_t, 4>::store_unaligned(int32_t* dst) const { store_aligned(dst); }
...
inline void batch<int32_t, 4>::store_unaligned(uint32_t* dst) const { store_aligned(dst); }

inline void batch<int32_t, 4>::store_aligned(float* dst) const { vst1q_f32(dst, vcvtq_f32_s32(this->m_value)); }

inline void batch<int32_t, 4>::store_unaligned(float* dst) const { store_aligned(dst); }
...
inline void batch<int32_t, 4>::store_unaligned(double* dst) const { store_aligned(dst); }

inline batch<int32_t, 4>::operator int32x4_t() const { return this->m_value; }

namespace detail {
template<> struct batch_kernel<int32_t, 4> : neon_int_kernel_base<batch<int32_t, 4>> {
	using batch_type = batch<int32_t, 4>;
	using value_type = int32_t;
	using batch_bool_type = batch_bool<int32_t, 4>;

	static batch_type neg(const batch_type& rhs) { return vnegq_s32(rhs); }

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return vaddq_s32(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return vsubq_s32(lhs, rhs); }

	static batch_type sadd(const batch_type& lhs, const batch_type& rhs) { return vqaddq_s32(lhs, rhs); }

	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return vqsubq_s32(lhs, rhs); }

	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return vmulq_s32(lhs, rhs); }
...
#else
		return neon_detail::unroll_op<4, int32x4_t, int32_t>(
		    [&lhs, &rhs](std::size_t idx) { return lhs[idx] / rhs[idx]; });
#endif
	}
	...
	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return vceqq_s32(lhs, rhs); }

	static batch_bool_type neq(const batch_type& lhs, const batch_type& rhs) { return !(lhs == rhs); }

	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return vcltq_s32(lhs, rhs); }

	static batch_bool_type lte(const batch_type& lhs, const batch_type& rhs) { return vcleq_s32(lhs, rhs); }

	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return vandq_s32(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return vorrq_s32(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return veorq_s32(lhs, rhs); }

	static batch_type bitwise_not(const batch_type& rhs) { return vmvnq_s32(rhs); }

	static batch_type bitwise_andnot(const batch_type& lhs, const batch_type& rhs) { return vbicq_s32(lhs, rhs); }

	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return vminq_s32(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return vmaxq_s32(lhs, rhs); }

	static batch_type abs(const batch_type& rhs) { return vabsq_s32(rhs); }
...
{
	switch (n) {
	case 0: return lhs; XSIMD_REPEAT_32(vshlq_n_s32);
	default: break;
	}
...
{
	switch (n) {
	case 0: return lhs; XSIMD_REPEAT_32(vshrq_n_s32);
	default: break;
	}
	return batch<int32_t, 4>(int32_t(0));
}
...
inline batch<int32_t, 4> operator<<(const batch<int32_t, 4>& lhs, int32_t rhs) { return detail::shift_left(lhs, rhs); }

inline batch<int32_t, 4> operator>>(const batch<int32_t, 4>& lhs, int32_t rhs) { return detail::shift_right(lhs, rhs); }
