...
template<> struct simd_batch_traits<batch_bool<double, 4>> {
...
template<> class batch_bool<double, 4> : public simd_batch_bool<batch_bool<double, 4>> {
public:
	batch_bool();
...
template<> struct simd_batch_traits<batch<double, 4>> {
	using value_type = double;
	static constexpr std::size_t size = 4;
...
template<> class batch<double, 4> : public simd_batch<batch<double, 4>> {
public:
...
inline batch_bool<double, 4>::batch_bool(bool b) { m_value = _mm256_castsi256_pd(_mm256_set1_epi32(-(int)b)); }

inline batch_bool<double, 4>::batch_bool(bool b0, bool b1, bool b2, bool b3)
{
	m_value = _mm256_castsi256_pd(
	    _mm256_setr_epi32(-(int)b0, -(int)b0, -(int)b1, -(int)b1, -(int)b2, -(int)b2, -(int)b3, -(int)b3));
}

inline batch_bool<double, 4>::batch_bool(const __m256d& rhs) { m_value = rhs; }
...
inline batch_bool<double, 4>::operator __m256d() const { return m_value; }
...
inline bool batch_bool<double, 4>::operator[](std::size_t index) const { return static_cast<bool>(m_array[index & 3]); }

inline __m256d batch_bool<double, 4>::get_value() const { return m_value; }
...
namespace detail {
template<> struct batch_bool_kernel<double, 4> {
	using batch_type = batch_bool<double, 4>;

	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return _mm256_and_pd(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return _mm256_or_pd(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return _mm256_xor_pd(lhs, rhs); }
	...
	static batch_type not_equal(const batch_type& lhs, const batch_type& rhs) { return _mm256_xor_pd(lhs, rhs); }

	static bool all(const batch_type& rhs) { return _mm256_testc_pd(rhs, batch_bool<double, 4>(true)) != 0; }

	static bool any(const batch_type& rhs) { return !_mm256_testz_pd(rhs, rhs); }
};
} // namespace detail
...
inline batch<double, 4>::operator __m256d() const { return this->m_value; }
...
inline batch<double, 4>& batch<double, 4>::load_unaligned(const int8_t* src) { return load_aligned(src); }
...
inline batch<double, 4>& batch<double, 4>::load_unaligned(const uint8_t* src) { return load_aligned(src); }
...
inline batch<double, 4>& batch<double, 4>::load_unaligned(const int16_t* src) { return load_aligned(src); }
...
inline batch<double, 4>& batch<double, 4>::load_unaligned(const uint16_t* src) { return load_aligned(src); }
...
inline void batch<double, 4>::store_unaligned(int8_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 4>::store_unaligned(uint8_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 4>::store_unaligned(int16_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 4>::store_unaligned(uint16_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 4>::store_aligned(float* dst) const { _mm_store_ps(dst, _mm256_cvtpd_ps(this->m_value)); }

inline void batch<double, 4>::store_unaligned(float* dst) const { _mm_storeu_ps(dst, _mm256_cvtpd_ps(this->m_value)); }

inline void batch<double, 4>::store_aligned(double* dst) const { _mm256_store_pd(dst, this->m_value); }

inline void batch<double, 4>::store_unaligned(double* dst) const { _mm256_storeu_pd(dst, this->m_value); }

namespace detail {
template<> struct batch_kernel<double, 4> {
	using batch_type = batch<double, 4>;
	using value_type = double;
	using batch_bool_type = batch_bool<double, 4>;
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm256_add_pd(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm256_sub_pd(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm256_mul_pd(lhs, rhs); }

	static batch_type div(const batch_type& lhs, const batch_type& rhs) { return _mm256_div_pd(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm256_min_pd(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm256_max_pd(lhs, rhs); }
	...
	static batch_type sqrt(const batch_type& rhs) { return _mm256_sqrt_pd(rhs); }
	...
	static batch_type
	select(const batch_bool_constant<value_type, Values...>&, const batch_type& a, const batch_type& b)
	{
		constexpr int mask = batch_bool_constant<value_type, Values...>::mask();
		return _mm256_blend_pd(b, a, mask);
	}

	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpacklo_pd(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpackhi_pd(lhs, rhs); }

	static batch_bool_type isnan(const batch_type& x) { return _mm256_cmp_pd(x, x, _CMP_UNORD_Q); }
};
} // namespace detail
} // namespace xsimd
