...
template<> struct simd_batch_traits<batch_bool<int8_t, 16>> {
...
template<> struct simd_batch_traits<batch_bool<uint8_t, 16>> {
...
template<> class batch_bool<int8_t, 16> : public sse_int_batch_bool<int8_t, 16> {
public:
	using sse_int_batch_bool::sse_int_batch_bool;
};

template<> class batch_bool<uint8_t, 16> : public sse_int_batch_bool<uint8_t, 16> {
public:
	using sse_int_batch_bool::sse_int_batch_bool;
};

namespace detail {
template<> struct batch_bool_kernel<int8_t, 16> : public sse_int_batch_bool_kernel<int8_t> {};

template<> struct batch_bool_kernel<uint8_t, 16> : public sse_int_batch_bool_kernel<uint8_t> {};
} // namespace detail
...
template<> class batch<int8_t, 16> : public sse_int_batch<int8_t, 16> {
public:
...
template<> class batch<uint8_t, 16> : public sse_int_batch<uint8_t, 16> {
public:
...
namespace detail {
template<class T> struct sse_int8_batch_kernel : sse_int_kernel_base<batch<T, 16>> {
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm_add_epi8(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm_sub_epi8(lhs, rhs); }

	static batch_type sadd(const batch_type& lhs, const batch_type& rhs) { return _mm_adds_epi8(lhs, rhs); }

	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return _mm_subs_epi8(lhs, rhs); }
	...
	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpeq_epi8(lhs, rhs); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm_unpacklo_epi8(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm_unpackhi_epi8(lhs, rhs); }
};

template<> struct batch_kernel<int8_t, 16> : sse_int8_batch_kernel<int8_t> {
	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return _mm_cmplt_epi8(lhs, rhs); }
...
template<> struct batch_kernel<uint8_t, 16> : public sse_int8_batch_kernel<uint8_t> {
	...
	static batch_type sadd(const batch_type& lhs, const batch_type& rhs) { return _mm_adds_epu8(lhs, rhs); }

	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return _mm_subs_epu8(lhs, rhs); }
};
} // namespace detail
