...
template<> struct simd_batch_traits<batch_bool<float, 8>> {
...
template<> class batch_bool<float, 8> : public simd_batch_bool<batch_bool<float, 8>> {
public:
	batch_bool();
...
private:
	batch_bool<float, 8>& load_values(bool b0, bool b1, bool b2, bool b3, bool b4, bool b5, bool b6, bool b7);
...
template<> struct simd_batch_traits<batch<float, 8>> {
	using value_type = float;
	static constexpr std::size_t size = 8;
...
template<> class batch<float, 8> : public simd_batch<batch<float, 8>> {
public:
	...
	batch(float f0, float f1, float f2, float f3, float f4, float f5, float f6, float f7);
...
inline batch_bool<float, 8>::batch_bool(bool b) { m_value = _mm256_castsi256_ps(_mm256_set1_epi32(-(int)b)); }

inline batch_bool<float, 8>::batch_bool(bool b0, bool b1, bool b2, bool b3, bool b4, bool b5, bool b6, bool b7)
{
	m_value = _mm256_castsi256_ps(
	    _mm256_setr_epi32(-(int)b0, -(int)b1, -(int)b2, -(int)b3, -(int)b4, -(int)b5, -(int)b6, -(int)b7));
}

inline batch_bool<float, 8>::batch_bool(const __m256& rhs) { m_value = rhs; }
...
inline batch_bool<float, 8>::operator __m256() const { return m_value; }
...
inline bool batch_bool<float, 8>::operator[](std::size_t index) const { return static_cast<bool>(m_array[index & 7]); }

inline __m256 batch_bool<float, 8>::get_value() const { return m_value; }

inline batch_bool<float, 8>&
batch_bool<float, 8>::load_values(bool b0, bool b1, bool b2, bool b3, bool b4, bool b5, bool b6, bool b7)
{
	m_value = _mm256_castsi256_ps(
	    _mm256_setr_epi32(-(int)b0, -(int)b1, -(int)b2, -(int)b3, -(int)b4, -(int)b5, -(int)b6, -(int)b7));
...
namespace detail {
template<> struct batch_bool_kernel<float, 8> {
	using batch_type = batch_bool<float, 8>;

	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return _mm256_and_ps(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return _mm256_or_ps(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return _mm256_xor_ps(lhs, rhs); }
	...
	static batch_type not_equal(const batch_type& lhs, const batch_type& rhs) { return _mm256_xor_ps(lhs, rhs); }

	static bool all(const batch_type& rhs) { return _mm256_testc_ps(rhs, batch_bool<float, 8>(true)) != 0; }

	static bool any(const batch_type& rhs) { return !_mm256_testz_ps(rhs, rhs); }
};
} // namespace detail
...
inline batch<float, 8>::batch(float f0, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
...
inline batch<float, 8>::operator __m256() const { return this->m_value; }
...
inline batch<float, 8>& batch<float, 8>::load_unaligned(const int8_t* src) { return load_aligned(src); }
...
inline batch<float, 8>& batch<float, 8>::load_unaligned(const uint8_t* src) { return load_aligned(src); }
...
inline void batch<float, 8>::store_unaligned(int8_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 8>::store_unaligned(uint8_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 8>::store_aligned(float* dst) const { _mm256_store_ps(dst, this->m_value); }

inline void batch<float, 8>::store_unaligned(float* dst) const { _mm256_storeu_ps(dst, this->m_value); }
...
inline void batch<float, 8>::store_unaligned(double* dst) const { store_aligned(dst); }

namespace detail {
template<> struct batch_kernel<float, 8> {
	using batch_type = batch<float, 8>;
	using value_type = float;
	using batch_bool_type = batch_bool<float, 8>;
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm256_add_ps(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm256_sub_ps(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm256_mul_ps(lhs, rhs); }

	static batch_type div(const batch_type& lhs, const batch_type& rhs) { return _mm256_div_ps(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm256_min_ps(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm256_max_ps(lhs, rhs); }
	...
	static batch_type sqrt(const batch_type& rhs) { return _mm256_sqrt_ps(rhs); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpacklo_ps(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpackhi_ps(lhs, rhs); }

	static batch_bool_type isnan(const batch_type& x) { return _mm256_cmp_ps(x, x, _CMP_UNORD_Q); }
};
} // namespace detail
} // namespace xsimd
