...
inline batch<float, 4>::batch(const batch_bool_type& rhs)
    : base_type(vreinterpretq_f32_u32(vandq_u32(rhs, vreinterpretq_u32_f32(batch(1.f)))))
{
}
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const int32_t* d) { return load_aligned(d); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const uint32_t* d) { return load_aligned(d); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const int64_t* d) { return load_aligned(d); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const uint64_t* d) { return load_aligned(d); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const float* d) { return load_aligned(d); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const double* d) { return load_aligned(d); }
...
inline void batch<float, 4>::store_aligned(int32_t* dst) const { vst1q_s32(dst, vcvtq_s32_f32(this->m_value)); }

inline void batch<float, 4>::store_unaligned(int32_t* dst) const { store_aligned(dst); }

inline void batch<float, 4>::store_aligned(uint32_t* dst) const { vst1q_u32(dst, vcvtq_u32_f32(this->m_value)); }

inline void batch<float, 4>::store_unaligned(uint32_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_unaligned(int64_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_unaligned(uint64_t* dst) const { store_aligned(dst); }

inline void batch<float, 4>::store_aligned(float* dst) const { vst1q_f32(dst, this->m_value); }

inline void batch<float, 4>::store_unaligned(float* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_unaligned(double* dst) const { store_aligned(dst); }

inline batch<float, 4>::operator float32x4_t() const { return this->m_value; }
...
template<> struct batch_kernel<float, 4> {
	...
	static batch_type neg(const batch_type& rhs) { return vnegq_f32(rhs); }

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return vaddq_f32(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return vsubq_f32(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return vmulq_f32(lhs, rhs); }
	...
	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return vceqq_f32(lhs, rhs); }

	static batch_bool_type neq(const batch_type& lhs, const batch_type& rhs) { return !(lhs == rhs); }

	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return vcltq_f32(lhs, rhs); }

	static batch_bool_type lte(const batch_type& lhs, const batch_type& rhs) { return vcleq_f32(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return vminq_f32(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return vmaxq_f32(lhs, rhs); }
	...
	static batch_type abs(const batch_type& rhs) { return vabsq_f32(rhs); }
