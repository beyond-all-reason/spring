...
template<> struct simd_batch_traits<batch_bool<int32_t, 8>> {
...
template<> struct simd_batch_traits<batch_bool<uint32_t, 8>> {
...
template<> class batch_bool<int32_t, 8> : public avx_int_batch_bool<int32_t, 8> {
public:
	using avx_int_batch_bool::avx_int_batch_bool;
};

template<> class batch_bool<uint32_t, 8> : public avx_int_batch_bool<uint32_t, 8> {
public:
	using avx_int_batch_bool::avx_int_batch_bool;
};

namespace detail {
template<> struct batch_bool_kernel<int32_t, 8> : public avx_int_batch_bool_kernel<int32_t, 8> {};

template<> struct batch_bool_kernel<uint32_t, 8> : public avx_int_batch_bool_kernel<uint32_t, 8> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<int32_t, 8>> {
	using value_type = int32_t;
	static constexpr std::size_t size = 8;
...
template<> struct simd_batch_traits<batch<uint32_t, 8>> {
	using value_type = uint32_t;
	static constexpr std::size_t size = 8;
...
template<> class batch<int32_t, 8> : public avx_int_batch<int32_t, 8> {
public:
...
template<> class batch<uint32_t, 8> : public avx_int_batch<uint32_t, 8> {
public:
...
namespace detail {
template<> struct batch_kernel<int32_t, 8> : avx_int_kernel_base<batch<int32_t, 8>> {
	using batch_type = batch<int32_t, 8>;
	using value_type = int32_t;
	using batch_bool_type = batch_bool<int32_t, 8>;
	...
	static batch_type div(const batch_type& lhs, const batch_type& rhs)
	{
		...
		unroller<8>([&](std::size_t i) { tmp_res[i] = tmp_lhs[i] / tmp_rhs[i]; });
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpacklo_epi32(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm256_unpackhi_epi32(lhs, rhs); }
};

template<> struct batch_kernel<uint32_t, 8> : avx_int_kernel_base<batch<uint32_t, 8>> {
	using batch_type = batch<uint32_t, 8>;
	using value_type = uint32_t;
	using batch_bool_type = batch_bool<uint32_t, 8>;
