...
namespace xsimd {
template<> struct simd_batch_traits<batch<double, 2>> {
...
template<> class batch<double, 2> : public simd_batch<batch<double, 2>> {
public:
...
inline batch<double, 2>::batch(const batch_bool_type& rhs)
    : base_type(vreinterpretq_f64_u64(vandq_u64(rhs, vreinterpretq_u64_f64(batch(1.)))))
{
}

inline batch<double, 2>& batch<double, 2>::operator=(const batch_bool_type& rhs)
{
	this->m_value = vreinterpretq_f64_u64(vandq_u64(rhs, vreinterpretq_u64_f64(batch(1.))));
	return *this;
}
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const int8_t* src) { return load_aligned(src); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const uint8_t* src) { return load_aligned(src); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const int16_t* src) { return load_aligned(src); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const uint16_t* src) { return load_aligned(src); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const int32_t* d) { return load_aligned(d); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const uint32_t* d) { return load_aligned(d); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const int64_t* d) { return load_aligned(d); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const uint64_t* d) { return load_aligned(d); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const float* d) { return load_aligned(d); }
...
inline batch<double, 2>& batch<double, 2>::load_unaligned(const double* d) { return load_aligned(d); }
...
inline void batch<double, 2>::store_unaligned(int8_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(uint8_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(int16_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(uint16_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(int32_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(uint32_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(int64_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(uint64_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 2>::store_unaligned(float* dst) const { store_aligned(dst); }

inline void batch<double, 2>::store_aligned(double* dst) const { vst1q_f64(dst, m_value); }

inline void batch<double, 2>::store_unaligned(double* dst) const { store_aligned(dst); }

inline batch<double, 2>::operator float64x2_t() const { return this->m_value; }

namespace detail {
template<> struct batch_kernel<double, 2> {
	using batch_type = batch<double, 2>;
	using value_type = double;
	using batch_bool_type = batch_bool<double, 2>;

	static batch_type neg(const batch_type& rhs) { return vnegq_f64(rhs); }

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return vaddq_f64(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return vsubq_f64(lhs, rhs); }

	static batch_type sadd(const batch_type& lhs, const batch_type& rhs) { return add(lhs, rhs); }

	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return sub(lhs, rhs); }

	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return vmulq_f64(lhs, rhs); }
	...
	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return vceqq_f64(lhs, rhs); }

	static batch_bool_type neq(const batch_type& lhs, const batch_type& rhs) { return !(lhs == rhs); }

	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return vcltq_f64(lhs, rhs); }

	static batch_bool_type lte(const batch_type& lhs, const batch_type& rhs) { return vcleq_f64(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return vminq_f64(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return vmaxq_f64(lhs, rhs); }
	...
	static batch_type abs(const batch_type& rhs) { return vabsq_f64(rhs); }
	...
	static batch_type fma(const batch_type& x, const batch_type& y, const batch_type& z) { return vfmaq_f64(z, x, y); }

	static batch_type fms(const batch_type& x, const batch_type& y, const batch_type& z) { return vfmaq_f64(-z, x, y); }

	static batch_type fnma(const batch_type& x, const batch_type& y, const batch_type& z) { return fma(-x, y, z); }

	static batch_type fnms(const batch_type& x, const batch_type& y, const batch_type& z) { return fms(-x, y, z); }
	...
	static batch_type haddp(const simd_batch<batch_type>* row) { return vpaddq_f64(row[0](), row[1]()); }
	...
	static batch_bool_type isnan(const batch_type& x) { return !(x == x); }
};
} // namespace detail
} // namespace xsimd
