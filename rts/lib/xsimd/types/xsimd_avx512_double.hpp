...
template<> struct simd_batch_traits<batch_bool<double, 8>> {
...
template<> class batch_bool<double, 8> : public batch_bool_avx512<__mmask8, batch_bool<double, 8>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<double, 8> : batch_bool_kernel_avx512<double, 8> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<double, 8>> {
	using value_type = double;
	static constexpr std::size_t size = 8;
...
template<> class batch<double, 8> : public simd_batch<batch<double, 8>> {
public:
...
inline batch<double, 8>::operator __m512d() const { return this->m_value; }
...
inline batch<double, 8>& batch<double, 8>::load_unaligned(const int8_t* src) { return load_aligned(src); }
...
inline batch<double, 8>& batch<double, 8>::load_unaligned(const uint8_t* src) { return load_aligned(src); }
...
inline void batch<double, 8>::store_unaligned(int8_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 8>::store_unaligned(uint8_t* dst) const { store_aligned(dst); }
...
inline void batch<double, 8>::store_aligned(float* dst) const { _mm256_store_ps(dst, _mm512_cvtpd_ps(this->m_value)); }
...
inline void batch<double, 8>::store_aligned(double* dst) const { _mm512_store_pd(dst, this->m_value); }

inline void batch<double, 8>::store_unaligned(double* dst) const { _mm512_storeu_pd(dst, this->m_value); }

namespace detail {
template<> struct batch_kernel<double, 8> {
	using batch_type = batch<double, 8>;
	using value_type = double;
	using batch_bool_type = batch_bool<double, 8>;
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm512_add_pd(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm512_sub_pd(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm512_mul_pd(lhs, rhs); }

	static batch_type div(const batch_type& lhs, const batch_type& rhs) { return _mm512_div_pd(lhs, rhs); }
	...
	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return _mm512_and_pd(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return _mm512_or_pd(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return _mm512_xor_pd(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm512_min_pd(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm512_max_pd(lhs, rhs); }
	...
	static batch_type abs(const batch_type& rhs)
	{
		...
		__m512i res_asi = _mm512_and_epi64(_mm512_set1_epi64(0x7FFFFFFFFFFFFFFF), rhs_asi);
		return *reinterpret_cast<__m512d*>(&res_asi);
	}

	static batch_type fabs(const batch_type& rhs) { return abs(rhs); }

	static batch_type sqrt(const batch_type& rhs) { return _mm512_sqrt_pd(rhs); }
...
#undef step1
	...
	static batch_bool_type isnan(const batch_type& x) { return _mm512_cmp_pd_mask(x, x, _CMP_UNORD_Q); }

	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpacklo_pd(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpackhi_pd(lhs, rhs); }
};
} // namespace detail
