...
template<> struct simd_batch_traits<batch_bool<int32_t, 4>> {
...
template<> struct simd_batch_traits<batch_bool<uint32_t, 4>> {
...
template<> class batch_bool<int32_t, 4> : public sse_int_batch_bool<int32_t, 4> {
public:
	using sse_int_batch_bool::sse_int_batch_bool;
};

template<> class batch_bool<uint32_t, 4> : public sse_int_batch_bool<uint32_t, 4> {
public:
	using sse_int_batch_bool::sse_int_batch_bool;
};

namespace detail {
template<> struct batch_bool_kernel<int32_t, 4> : public sse_int_batch_bool_kernel<int32_t> {};

template<> struct batch_bool_kernel<uint32_t, 4> : public sse_int_batch_bool_kernel<uint32_t> {};
} // namespace detail
...
template<> class batch<int32_t, 4> : public sse_int_batch<int32_t, 4> {
public:
...
template<> class batch<uint32_t, 4> : public sse_int_batch<uint32_t, 4> {
public:
...
#define SSE_DEFINE_LOAD_STORE_INT32(TYPE, CVT_TYPE)                                                          \
	...
	inline batch<TYPE, 4>& batch<TYPE, 4>::load_unaligned(const CVT_TYPE* src) { return load_aligned(src); } \
	inline void batch<TYPE, 4>::store_aligned(CVT_TYPE* dst) const                                           \
	{                                                                                                        \
		sse_detail::store_aligned_int32(this->m_value, dst);                                                 \
	}                                                                                                        \
	inline void batch<TYPE, 4>::store_unaligned(CVT_TYPE* dst) const { store_aligned(dst); }
...
inline void batch<int32_t, 4>::store_aligned(float* dst) const { _mm_store_ps(dst, _mm_cvtepi32_ps(this->m_value)); }

inline void batch<int32_t, 4>::store_unaligned(float* dst) const { _mm_storeu_ps(dst, _mm_cvtepi32_ps(this->m_value)); }
...
namespace detail {
template<class T> struct sse_int32_batch_kernel : sse_int_kernel_base<batch<T, 4>> {
	using batch_type = batch<T, 4>;
	using value_type = T;
	using batch_bool_type = batch_bool<T, 4>;

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm_add_epi32(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm_sub_epi32(lhs, rhs); }
	...
	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpeq_epi32(lhs, rhs); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm_unpacklo_epi32(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm_unpackhi_epi32(lhs, rhs); }
};

template<> struct batch_kernel<int32_t, 4> : sse_int32_batch_kernel<int32_t> {
	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return _mm_cmplt_epi32(lhs, rhs); }
...
template<> struct batch_kernel<uint32_t, 4> : sse_int32_batch_kernel<uint32_t> {
...
inline batch<int32_t, 4> operator<<(const batch<int32_t, 4>& lhs, int32_t rhs) { return _mm_slli_epi32(lhs, rhs); }

inline batch<int32_t, 4> operator>>(const batch<int32_t, 4>& lhs, int32_t rhs) { return _mm_srai_epi32(lhs, rhs); }
...
inline batch<uint32_t, 4> operator<<(const batch<uint32_t, 4>& lhs, int32_t rhs) { return _mm_slli_epi32(lhs, rhs); }

inline batch<uint32_t, 4> operator>>(const batch<uint32_t, 4>& lhs, int32_t rhs) { return _mm_srli_epi32(lhs, rhs); }
