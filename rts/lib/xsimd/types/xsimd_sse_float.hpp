...
template<> struct simd_batch_traits<batch_bool<float, 4>> {
...
template<> class batch_bool<float, 4> : public simd_batch_bool<batch_bool<float, 4>> {
public:
	batch_bool();
...
template<> struct simd_batch_traits<batch<float, 4>> {
	using value_type = float;
	static constexpr std::size_t size = 4;
...
template<> class batch<float, 4> : public simd_batch<batch<float, 4>> {
public:
...
inline batch_bool<float, 4>::batch_bool(bool b) { m_value = _mm_castsi128_ps(_mm_set1_epi32(-(int)b)); }
...
inline batch_bool<float, 4>::batch_bool(const __m128& rhs) { m_value = rhs; }
...
inline batch_bool<float, 4>::operator __m128() const { return m_value; }
...
inline bool batch_bool<float, 4>::operator[](std::size_t index) const { return static_cast<bool>(m_array[index & 3]); }

inline __m128 batch_bool<float, 4>::get_value() const { return m_value; }
...
namespace detail {
template<> struct batch_bool_kernel<float, 4> {
	using batch_type = batch_bool<float, 4>;

	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return _mm_and_ps(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return _mm_or_ps(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return _mm_xor_ps(lhs, rhs); }
	...
	static batch_type bitwise_andnot(const batch_type& lhs, const batch_type& rhs) { return _mm_andnot_ps(lhs, rhs); }
	...
	static batch_type not_equal(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpneq_ps(lhs, rhs); }

	static bool all(const batch_type& rhs) { return _mm_movemask_ps(rhs) == 0x0F; }

	static bool any(const batch_type& rhs) { return _mm_movemask_ps(rhs) != 0; }
};
} // namespace detail
...
inline batch<float, 4>::operator __m128() const { return this->m_value; }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const int8_t* src) { return load_aligned(src); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const uint8_t* src) { return load_aligned(src); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const int16_t* src) { return load_aligned(src); }
...
inline batch<float, 4>& batch<float, 4>::load_unaligned(const uint16_t* src) { return load_aligned(src); }
...
inline void batch<float, 4>::store_unaligned(int8_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_unaligned(uint8_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_unaligned(int16_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_aligned(uint16_t* dst) const
{
	...
	unroller<4>([&](std::size_t i) { dst[i] = static_cast<uint16_t>(tmp[i]); });
#endif
}

inline void batch<float, 4>::store_unaligned(uint16_t* dst) const { store_aligned(dst); }
...
inline void batch<float, 4>::store_aligned(float* dst) const { _mm_store_ps(dst, this->m_value); }

inline void batch<float, 4>::store_unaligned(float* dst) const { _mm_storeu_ps(dst, this->m_value); }
...
namespace detail {
template<> struct batch_kernel<float, 4> {
	using batch_type = batch<float, 4>;
	using value_type = float;
	using batch_bool_type = batch_bool<float, 4>;
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm_add_ps(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm_sub_ps(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm_mul_ps(lhs, rhs); }

	static batch_type div(const batch_type& lhs, const batch_type& rhs) { return _mm_div_ps(lhs, rhs); }

	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpeq_ps(lhs, rhs); }

	static batch_bool_type neq(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpneq_ps(lhs, rhs); }

	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return _mm_cmplt_ps(lhs, rhs); }

	static batch_bool_type lte(const batch_type& lhs, const batch_type& rhs) { return _mm_cmple_ps(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm_min_ps(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm_max_ps(lhs, rhs); }
	...
	static batch_type sqrt(const batch_type& rhs) { return _mm_sqrt_ps(rhs); }
	...
	static batch_bool_type isnan(const batch_type& x) { return _mm_cmpunord_ps(x, x); }

	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm_unpacklo_ps(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm_unpackhi_ps(lhs, rhs); }
};
} // namespace detail
} // namespace xsimd
