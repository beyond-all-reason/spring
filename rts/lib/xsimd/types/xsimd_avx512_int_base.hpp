...
namespace detail {
template<std::size_t N> struct mask_type;

template<> struct mask_type<8> {
	using type = __mmask8;
};

template<> struct mask_type<16> {
	using type = __mmask16;
};

template<> struct mask_type<32> {
	using type = __mmask32;
};

template<> struct mask_type<64> {
	using type = __mmask64;
};

template<std::size_t N> using mask_type_t = typename mask_type<N>::type;
} // namespace detail

template<class T, std::size_t N> class avx512_int_batch : public simd_batch<batch<T, N>> {
public:
    ...
    int8_t t63)
{
	...
	return __extension__(__m512i)(__v64qi){t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16,
	    t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, t33, t34, t35, t36, t37, t38,
	    t39, t40, t41, t42, t43, t44, t45, t46, t47, t48, t49, t50, t51, t52, t53, t54, t55, t56, t57, t58, t59, t60,
	    t61, t62, t63};
#else
	return _mm512_set_epi8(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19,
	    t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, t33, t34, t35, t36, t37, t38, t39, t40, t41,
	    t42, t43, t44, t45, t46, t47, t48, t49, t50, t51, t52, t53, t54, t55, t56, t57, t58, t59, t60, t61, t62, t63);
#endif
}
...
{
#if defined(__clang__) || __GNUC__
	return __extension__(__m512i)(__v32hi){t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16,
	    t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31};
#else
	return _mm512_set_epi16(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19,
...
template<class T> inline __m512i int_set(std::integral_constant<std::size_t, 1>, T v) { return _mm512_set1_epi8(v); }

template<class T> inline __m512i int_set(std::integral_constant<std::size_t, 2>, T v) { return _mm512_set1_epi16(v); }

template<class T> inline __m512i int_set(std::integral_constant<std::size_t, 4>, T v) { return _mm512_set1_epi32(v); }

template<class T> inline __m512i int_set(std::integral_constant<std::size_t, 8>, T v) { return _mm512_set1_epi64(v); }
} // namespace avx512_detail

template<class T, std::size_t N> inline avx512_int_batch<T, N>::avx512_int_batch() {}
...
template<class T, std::size_t N> inline avx512_int_batch<T, N>& avx512_int_batch<T, N>::operator=(const __m512i& rhs)
{
	this->m_value = rhs;
	return *this;
}
...
template<class T, std::size_t N> avx512_int_batch<T, N>& avx512_int_batch<T, N>::operator=(const batch_bool<T, N>& rhs)
{
	this->m_value = detail::batch_kernel<T, N>::select(rhs, batch<T, N>(T(1)), batch<T, N>(T(0)));
	return *this;
}

template<class T, std::size_t N> inline avx512_int_batch<T, N>::operator __m512i() const { return this->m_value; }

template<class T, std::size_t N> inline batch<T, N>& avx512_int_batch<T, N>::load_aligned(const T* src)
{
	this->m_value = _mm512_load_si512((__m512i const *)src);
	return (*this)();
}

template<class T, std::size_t N> inline batch<T, N>& avx512_int_batch<T, N>::load_unaligned(const T* src)
{
...
template<class T, std::size_t N> inline void avx512_int_batch<T, N>::store_aligned(T* dst) const
{
	_mm512_store_si512(dst, this->m_value);
}

template<class T, std::size_t N> inline void avx512_int_batch<T, N>::store_unaligned(T* dst) const
{
	_mm512_storeu_si512(dst, this->m_value);
}

template<class T, std::size_t N> inline void avx512_int_batch<T, N>::store_aligned(flipped_sign_type_t<T>* dst) const
{
	_mm512_store_si512(dst, this->m_value);
}

template<class T, std::size_t N> inline void avx512_int_batch<T, N>::store_unaligned(flipped_sign_type_t<T>* dst) const
{
	_mm512_storeu_si512(dst, this->m_value);
}

namespace detail {
template<class B> struct avx512_int_kernel_base {
	using batch_type = B;
