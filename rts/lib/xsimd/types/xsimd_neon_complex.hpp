...
template<>
class batch_bool<std::complex<float>, 4> : public simd_complex_batch_bool<batch_bool<std::complex<float>, 4>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<std::complex<float>, 4> : batch_bool_complex_kernel<std::complex<float>, 4> {};
} // namespace detail
...
template<>
struct simd_batch_traits<batch<std::complex<float>, 4>> : complex_batch_traits<std::complex<float>, float, 4, 32> {};

template<> class batch<std::complex<float>, 4> : public simd_complex_batch<batch<std::complex<float>, 4>> {
public:
...
#else
	this->m_real = real_batch(
	    static_cast<float>(buf[0]), static_cast<float>(buf[2]), static_cast<float>(buf[4]), static_cast<float>(buf[6]));
	this->m_imag = real_batch(
	    static_cast<float>(buf[1]), static_cast<float>(buf[3]), static_cast<float>(buf[5]), static_cast<float>(buf[7]));
#endif
	return *this;
}
...
inline void batch<std::complex<float>, 4>::store_unaligned(std::complex<float>* dst) const { store_aligned(dst); }

inline void batch<std::complex<float>, 4>::store_aligned(std::complex<double>* dst) const
{
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
	double* buf = reinterpret_cast<double*>(dst);
	float64x2x2_t tmp0{vcvt_f64_f32(vget_low_f32(this->m_real)), vcvt_f64_f32(vget_low_f32(this->m_imag))};
	float64x2x2_t tmp1{vcvt_f64_f32(vget_high_f32(this->m_real)), vcvt_f64_f32(vget_high_f32(this->m_imag))};
	vst2q_f64(buf, tmp0);
...
inline void batch<std::complex<float>, 4>::store_unaligned(std::complex<double>* dst) const { store_aligned(dst); }
...
template<>
class batch_bool<std::complex<double>, 2> : public simd_complex_batch_bool<batch_bool<std::complex<double>, 2>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<std::complex<double>, 2> : batch_bool_complex_kernel<std::complex<double>, 2> {};
} // namespace detail
...
template<>
struct simd_batch_traits<batch<std::complex<double>, 2>> : complex_batch_traits<std::complex<double>, double, 2, 32> {};

template<> class batch<std::complex<double>, 2> : public simd_complex_batch<batch<std::complex<double>, 2>> {
public:
	...
	batch(value_type c0, value_type c1)
	    : base_type(real_batch(c0.real(), c1.real()), real_batch(c0.imag(), c1.imag()))
	{
	}
...
template<bool i3ec>
inline auto batch<xtl::xcomplex<float, float, i3ec>, 4>::load_aligned(const xtl::complex<double, double, i3ec>* src)
    -> self_type&
{
	const double* buf = reinterpret_cast<const double*>(src);
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
...
template<bool i3ec>
inline auto batch<xtl::xcomplex<float, float, i3ec>, 4>::load_unaligned(const xtl::complex<double, double, i3ec>* src)
    -> self_type&
{
	return load_unaligned(src);
}

template<bool i3ec> inline void batch<xtl::xcomplex<float, float, i3ec>, 4>::store_aligned(value_type* dst) const
{
	float32x4x2_t tmp;
	tmp.val[0] = this->m_real;
	tmp.val[1] = this->m_imag;
...
template<bool i3ec> inline void batch<xtl::xcomplex<float, float, i3ec>, 4>::store_unaligned(value_type* dst) const
{
	store_aligned(dst);
}
...
template<bool i3ec>
    inline void batch <
    xtl::xcomplex<float, float, i3ec, 4>::store_aligned(xtl::xcomplex<double, double, i3ec>* dst) const
{
#if XSIMD_ARM_INSTR_SET >= XSIMD_ARM8_64_NEON_VERSION
	double* buf = reinterpret_cast<double*>(dst);
	float64x2x2_t tmp0{vcvt_f64_f32(vget_low_f32(this->m_real)), vcvt_f64_f32(vget_low_f32(this->m_imag))};
...
template<bool i3ec>
inline auto batch<xtl::xcomplex<double, double, i3ec>, 2>::load_aligned(const xtl::xcomplex<float, float, i3ec>* src)
    -> self_type&
{
	const float* buf = reinterpret_cast<const float*>(src);
	float32x2x2_t tmp = vld2_f32(buf);
...
template<bool i3ec>
inline auto batch<xtl::xcomplex<double, double, i3ec>, 2>::load_unaligned(const xtl::xcomplex<float, float, i3ec>* src)
    -> self_type&
{
	return load_aligned(src);
}
...
template<bool i3ec> inline void batch<xtl::xcomplex<double, double, i3ec>, 2>::store_aligned(value_type* dst) const
{
	float64x2x2_t tmp;
	tmp.val[0] = this->m_real;
	tmp.val[1] = this->m_imag;
...
template<bool i3ec> inline void batch<xtl::xcomplex<double, double, i3ec>, 2>::store_unaligned(value_type* dst) const
{
	return store_aligned(dst);
}
