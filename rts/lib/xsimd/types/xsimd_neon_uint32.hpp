...
template<> struct simd_batch_traits<batch<uint32_t, 4>> {
...
template<> class batch<uint32_t, 4> : public simd_batch<batch<uint32_t, 4>> {
public:
	...
	template<class... Args, class Enable = detail::is_array_initializer_t<uint32_t, 4, Args...>> batch(Args... args);
...
inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const int16_t* src) { return load_aligned(src); }
...
inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const uint16_t* src) { return load_aligned(src); }
...
inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const int32_t* src) { return load_aligned(src); }
...
inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const uint32_t* src) { return load_aligned(src); }
...
inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_aligned(const double* src)
{
	...
	return *this;
#else
	this->m_value = uint32x4_t{static_cast<uint32_t>(src[0]), static_cast<uint32_t>(src[1]),
	    static_cast<uint32_t>(src[2]), static_cast<uint32_t>(src[3])};
#endif
	return *this;
}

inline batch<uint32_t, 4>& batch<uint32_t, 4>::load_unaligned(const double* src) { return load_aligned(src); }
...
inline void batch<uint32_t, 4>::store_unaligned(int16_t* dst) const { store_aligned(dst); }
...
inline void batch<uint32_t, 4>::store_unaligned(uint16_t* dst) const { store_aligned(dst); }
...
inline void batch<uint32_t, 4>::store_unaligned(int32_t* dst) const { store_aligned(dst); }

inline void batch<uint32_t, 4>::store_aligned(uint32_t* dst) const { vst1q_u32(dst, this->m_value); }

inline void batch<uint32_t, 4>::store_unaligned(uint32_t* dst) const { store_aligned(dst); }

inline void batch<uint32_t, 4>::store_aligned(float* dst) const { vst1q_f32(dst, vcvtq_f32_u32(this->m_value)); }

inline void batch<uint32_t, 4>::store_unaligned(float* dst) const { store_aligned(dst); }
...
inline void batch<uint32_t, 4>::store_unaligned(double* dst) const { store_aligned(dst); }

inline batch<uint32_t, 4>::operator storage_type() const { return this->m_value; }

namespace detail {
template<> struct batch_kernel<uint32_t, 4> : neon_int_kernel_base<batch<uint32_t, 4>> {
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return vaddq_u32(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return vsubq_u32(lhs, rhs); }

	static batch_type sadd(const batch_type& lhs, const batch_type& rhs) { return vqaddq_u32(lhs, rhs); }

	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return vqsubq_u32(lhs, rhs); }

	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return vmulq_u32(lhs, rhs); }
...
#else
		return neon_detail::unroll_op<4, uint32x4_t, uint32_t>(
	...
	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return vceqq_u32(lhs, rhs); }

	static batch_bool_type neq(const batch_type& lhs, const batch_type& rhs) { return !(lhs == rhs); }

	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return vcltq_u32(lhs, rhs); }

	static batch_bool_type lte(const batch_type& lhs, const batch_type& rhs) { return vcleq_u32(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return vminq_u32(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return vmaxq_u32(lhs, rhs); }

	static batch_type abs(const batch_type& rhs) { return rhs; }
...
{
	switch (n) {
	case 0: return lhs; XSIMD_REPEAT_32(vshlq_n_u32);
	default: break;
	}
...
{
	switch (n) {
	case 0: return lhs; XSIMD_REPEAT_32(vshrq_n_u32);
	default: break;
	}
	return batch<uint32_t, 4>(uint32_t(0));
}
