...
template<> struct simd_batch_traits<batch<int64_t, 2>> {
...
template<> class batch<int64_t, 2> : public simd_batch<batch<int64_t, 2>> {
public:
	...
	template<class... Args, class Enable = detail::is_array_initializer_t<int64_t, 2, Args...>> batch(Args... args);
...
namespace detail {
inline int64x2_t init_from_bool(uint64x2_t a) { return vandq_s64(reinterpret_cast<int64x2_t>(a), vdupq_n_s64(1)); }
} // namespace detail
...
inline batch<int64_t, 2>& batch<int64_t, 2>::load_unaligned(const int32_t* src) { return load_aligned(src); }
...
inline batch<int64_t, 2>& batch<int64_t, 2>::load_unaligned(const uint32_t* src) { return load_aligned(src); }
...
inline batch<int64_t, 2>& batch<int64_t, 2>::load_unaligned(const int64_t* src) { return load_aligned(src); }
...
inline batch<int64_t, 2>& batch<int64_t, 2>::load_unaligned(const uint64_t* src) { return load_aligned(src); }
...
#else
	this->m_value = int64x2_t{static_cast<int64_t>(src[0]), static_cast<int64_t>(src[1])};
#endif
	return *this;
}

inline batch<int64_t, 2>& batch<int64_t, 2>::load_unaligned(const float* src) { return load_aligned(src); }
...
inline batch<int64_t, 2>& batch<int64_t, 2>::load_unaligned(const double* src) { return load_aligned(src); }
...
inline void batch<int64_t, 2>::store_unaligned(int32_t* dst) const { store_aligned(dst); }
...
inline void batch<int64_t, 2>::store_unaligned(uint32_t* dst) const { store_aligned(dst); }

inline void batch<int64_t, 2>::store_aligned(int64_t* dst) const { vst1q_s64(dst, this->m_value); }

inline void batch<int64_t, 2>::store_unaligned(int64_t* dst) const { store_aligned(dst); }
...
inline void batch<int64_t, 2>::store_unaligned(uint64_t* dst) const { store_aligned(dst); }
...
inline void batch<int64_t, 2>::store_unaligned(float* dst) const { store_aligned(dst); }
...
inline void batch<int64_t, 2>::store_unaligned(double* dst) const { store_aligned(dst); }

inline batch<int64_t, 2>::operator storage_type() const { return this->m_value; }

namespace detail {
template<> struct batch_kernel<int64_t, 2> : neon_int_kernel_base<batch<int64_t, 2>> {
	...
	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return vaddq_s64(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return vsubq_s64(lhs, rhs); }

	static batch_type sadd(const batch_type& lhs, const batch_type& rhs) { return vqaddq_s64(lhs, rhs); }

	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return vqsubq_s64(lhs, rhs); }

	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return {lhs[0] * rhs[0], lhs[1] * rhs[1]}; }
	...
	static batch_type mod(const batch_type& lhs, const batch_type& rhs) { return {lhs[0] % rhs[0], lhs[1] % rhs[1]}; }
	...
	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return vandq_s64(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return vorrq_s64(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return veorq_s64(lhs, rhs); }
	...
	static batch_type bitwise_andnot(const batch_type& lhs, const batch_type& rhs) { return vbicq_s64(lhs, rhs); }
...
{
	switch (n) {
	case 0: return lhs; XSIMD_REPEAT_64(vshlq_n_s64);
	default: break;
	}
...
{
	switch (n) {
	case 0: return lhs; XSIMD_REPEAT_64(vshrq_n_s64);
	default: break;
	}
	return batch<int64_t, 2>(int64_t(0));
}
...
inline batch<int64_t, 2> operator<<(const batch<int64_t, 2>& lhs, int32_t rhs) { return detail::shift_left(lhs, rhs); }

inline batch<int64_t, 2> operator>>(const batch<int64_t, 2>& lhs, int32_t rhs) { return detail::shift_right(lhs, rhs); }
