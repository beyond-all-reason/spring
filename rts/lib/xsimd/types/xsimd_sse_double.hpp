...
template<> struct simd_batch_traits<batch_bool<double, 2>> {
...
template<> class batch_bool<double, 2> : public simd_batch_bool<batch_bool<double, 2>> {
public:
	batch_bool();
...
inline batch_bool<double, 2>::batch_bool(bool b) { m_value = _mm_castsi128_pd(_mm_set1_epi32(-(int)b)); }
...
inline batch_bool<double, 2>::batch_bool(const __m128d& rhs) { m_value = rhs; }
...
inline batch_bool<double, 2>::operator __m128d() const { return m_value; }
...
inline bool batch_bool<double, 2>::operator[](std::size_t index) const { return static_cast<bool>(m_array[index & 1]); }

inline __m128d batch_bool<double, 2>::get_value() const { return m_value; }
...
namespace detail {
template<> struct batch_bool_kernel<double, 2> {
	using batch_type = batch_bool<double, 2>;

	static batch_type bitwise_and(const batch_type& lhs, const batch_type& rhs) { return _mm_and_pd(lhs, rhs); }

	static batch_type bitwise_or(const batch_type& lhs, const batch_type& rhs) { return _mm_or_pd(lhs, rhs); }

	static batch_type bitwise_xor(const batch_type& lhs, const batch_type& rhs) { return _mm_xor_pd(lhs, rhs); }
	...
	static batch_type bitwise_andnot(const batch_type& lhs, const batch_type& rhs) { return _mm_andnot_pd(lhs, rhs); }
	...
	static batch_type not_equal(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpneq_pd(lhs, rhs); }

	static bool all(const batch_type& rhs) { return _mm_movemask_pd(rhs) == 3; }

	static bool any(const batch_type& rhs) { return _mm_movemask_pd(rhs) != 0; }
};
} // namespace detail
...
inline batch<double, 2>::operator __m128d() const { return this->m_value; }
...
inline void batch<double, 2>::store_aligned(uint16_t* dst) const
{
	...
	unroller<2>([&](std::size_t i) { dst[i] = static_cast<uint16_t>(tmp[i]); });
#endif
}

inline void batch<double, 2>::store_unaligned(uint16_t* dst) const { store_aligned(dst); }

inline void batch<double, 2>::store_aligned(double* dst) const { _mm_store_pd(dst, this->m_value); }

inline void batch<double, 2>::store_unaligned(double* dst) const { _mm_storeu_pd(dst, this->m_value); }
...
template<> struct batch_kernel<double, 2> {
	...
	{
		return _mm_xor_pd(rhs, _mm_castsi128_pd(_mm_setr_epi32(0, 0x80000000, 0, 0x80000000)));
	}

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm_add_pd(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm_sub_pd(lhs, rhs); }
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm_mul_pd(lhs, rhs); }

	static batch_type div(const batch_type& lhs, const batch_type& rhs) { return _mm_div_pd(lhs, rhs); }

	static batch_bool_type eq(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpeq_pd(lhs, rhs); }

	static batch_bool_type neq(const batch_type& lhs, const batch_type& rhs) { return _mm_cmpneq_pd(lhs, rhs); }

	static batch_bool_type lt(const batch_type& lhs, const batch_type& rhs) { return _mm_cmplt_pd(lhs, rhs); }

	static batch_bool_type lte(const batch_type& lhs, const batch_type& rhs) { return _mm_cmple_pd(lhs, rhs); }
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm_min_pd(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm_max_pd(lhs, rhs); }
	...
	static batch_type sqrt(const batch_type& rhs) { return _mm_sqrt_pd(rhs); }
	...
	static batch_bool_type isnan(const batch_type& x) { return _mm_cmpunord_pd(x, x); }

	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm_unpacklo_pd(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm_unpackhi_pd(lhs, rhs); }
};
} // namespace detail
} // namespace xsimd
