...
#define XSIMD_APPLY_AVX2_FUNCTION_INT16(func, avx_lhs, avx_rhs) XSIMD_APPLY_AVX2_FUNCTION(16, func, avx_lhs, avx_rhs)

/***************************
 * batch_bool<int16_t, 32> *
 ***************************/

template<> struct simd_batch_traits<batch_bool<int16_t, 32>> {
...
template<> struct simd_batch_traits<batch_bool<uint16_t, 32>> {
...
template<> class batch_bool<int16_t, 32> : public batch_bool_avx512<__mmask32, batch_bool<int16_t, 32>> {
public:
	using base_class = batch_bool_avx512<__mmask32, batch_bool<int16_t, 32>>;
	using base_class::base_class;
};

template<> class batch_bool<uint16_t, 32> : public batch_bool_avx512<__mmask32, batch_bool<uint16_t, 32>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<int16_t, 32> : batch_bool_kernel_avx512<int16_t, 32> {};

template<> struct batch_bool_kernel<uint16_t, 32> : batch_bool_kernel_avx512<uint16_t, 32> {};
} // namespace detail

#else

template<> class batch_bool<int16_t, 32> : public avx512_fallback_batch_bool<int16_t, 32> {
public:
	using base_class = avx512_fallback_batch_bool<int16_t, 32>;
	using base_class::base_class;
};

template<> class batch_bool<uint16_t, 32> : public avx512_fallback_batch_bool<uint16_t, 32> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<int16_t, 32> : avx512_fallback_batch_bool_kernel<int16_t, 32> {};

template<> struct batch_bool_kernel<uint16_t, 32> : avx512_fallback_batch_bool_kernel<uint16_t, 32> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<int16_t, 32>> {
	using value_type = int16_t;
	static constexpr std::size_t size = 32;
...
template<> struct simd_batch_traits<batch<uint16_t, 32>> {
	using value_type = uint16_t;
	static constexpr std::size_t size = 32;
...
template<> class batch<int16_t, 32> : public avx512_int_batch<int16_t, 32> {
public:
...
template<> class batch<uint16_t, 32> : public avx512_int_batch<uint16_t, 32> {
public:
	using base_class = avx512_int_batch;
	using base_class::base_class;
	using base_class::load_aligned;
...
namespace detail {
template<class T> struct avx512_int16_batch_kernel : avx512_int_kernel_base<batch<T, 32>> {
	...
	static batch_type bitwise_not(const batch_type& rhs) { return _mm512_xor_si512(rhs, _mm512_set1_epi16(-1)); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpacklo_epi16(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpackhi_epi16(lhs, rhs); }
};

template<> struct batch_kernel<int16_t, 32> : public avx512_int16_batch_kernel<int16_t> {
...
template<> struct batch_kernel<uint16_t, 32> : public avx512_int16_batch_kernel<uint16_t> {
