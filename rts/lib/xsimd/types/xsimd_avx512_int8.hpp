...
#define XSIMD_APPLY_AVX2_FUNCTION_INT8(func, avx_lhs, avx_rhs) XSIMD_APPLY_AVX2_FUNCTION(32, func, avx_lhs, avx_rhs)

/****************************
 * batch_bool<int8 / int16> *
 ****************************/

template<> struct simd_batch_traits<batch_bool<int8_t, 64>> {
...
template<> struct simd_batch_traits<batch_bool<uint8_t, 64>> {
...
template<> class batch_bool<int8_t, 64> : public batch_bool_avx512<__mmask64, batch_bool<int8_t, 64>> {
public:
	using base_class = batch_bool_avx512<__mmask64, batch_bool<int8_t, 64>>;
	using base_class::base_class;
};

template<> class batch_bool<uint8_t, 64> : public batch_bool_avx512<__mmask64, batch_bool<uint8_t, 64>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<int8_t, 64> : batch_bool_kernel_avx512<int8_t, 64> {};

template<> struct batch_bool_kernel<uint8_t, 64> : batch_bool_kernel_avx512<uint8_t, 64> {};
} // namespace detail

#else

template<> class batch_bool<int8_t, 64> : public avx512_fallback_batch_bool<int8_t, 64> {
public:
	using base_class = avx512_fallback_batch_bool<int8_t, 64>;
	using base_class::base_class;
};

template<> class batch_bool<uint8_t, 64> : public avx512_fallback_batch_bool<uint8_t, 64> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<int8_t, 64> : avx512_fallback_batch_bool_kernel<int8_t, 64> {};

template<> struct batch_bool_kernel<uint8_t, 64> : avx512_fallback_batch_bool_kernel<uint8_t, 64> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<int8_t, 64>> {
	using value_type = int8_t;
	static constexpr std::size_t size = 64;
...
template<> struct simd_batch_traits<batch<uint8_t, 64>> {
	using value_type = uint8_t;
	static constexpr std::size_t size = 64;
...
template<> class batch<int8_t, 64> : public avx512_int_batch<int8_t, 64> {
public:
...
template<> class batch<uint8_t, 64> : public avx512_int_batch<uint8_t, 64> {
public:
	using base_class = avx512_int_batch;
	using base_class::base_class;
	using base_class::load_aligned;
...
namespace detail {
template<class T> struct avx512_int8_batch_kernel : avx512_int_kernel_base<batch<T, 64>> {
	...
	static batch_type mul(const batch_type& lhs, const batch_type& rhs)
	{
		...
		batch_type lower =
		    _mm512_slli_epi16(_mm512_mullo_epi16(_mm512_srli_epi16(lhs, 8), _mm512_srli_epi16(rhs, 8)), 8);
	...
	static batch_type bitwise_not(const batch_type& rhs) { return _mm512_xor_si512(rhs, _mm512_set1_epi8(-1)); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpacklo_epi8(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpackhi_epi8(lhs, rhs); }
};

template<> struct batch_kernel<int8_t, 64> : public avx512_int8_batch_kernel<int8_t> {
...
template<> struct batch_kernel<uint8_t, 64> : public avx512_int8_batch_kernel<uint8_t> {
