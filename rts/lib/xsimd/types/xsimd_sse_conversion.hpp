...
inline batch<int32_t, 4> to_int(const batch<float, 4>& x) { return _mm_cvttps_epi32(x); }
...
inline batch<float, 4> to_float(const batch<int32_t, 4>& x) { return _mm_cvtepi32_ps(x); }
...
inline batch_bool<int32_t, 4> bool_cast(const batch_bool<float, 4>& x) { return _mm_castps_si128(x); }

inline batch_bool<int64_t, 2> bool_cast(const batch_bool<double, 2>& x) { return _mm_castpd_si128(x); }

inline batch_bool<float, 4> bool_cast(const batch_bool<int32_t, 4>& x) { return _mm_castsi128_ps(x); }

inline batch_bool<double, 2> bool_cast(const batch_bool<int64_t, 2>& x) { return _mm_castsi128_pd(x); }
