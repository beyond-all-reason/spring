...
template<>
class batch_bool<std::complex<float>, 8> : public simd_complex_batch_bool<batch_bool<std::complex<float>, 8>> {
public:
...
template<>
struct simd_batch_traits<batch<std::complex<float>, 8>> : complex_batch_traits<std::complex<float>, float, 8, 32> {};

template<> class batch<std::complex<float>, 8> : public simd_complex_batch<batch<std::complex<float>, 8>> {
public:
...
template<>
class batch_bool<std::complex<double>, 4> : public simd_complex_batch_bool<batch_bool<std::complex<double>, 4>> {
public:
...
template<>
struct simd_batch_traits<batch<std::complex<double>, 4>> : complex_batch_traits<std::complex<double>, double, 4, 32> {};

template<> class batch<std::complex<double>, 4> : public simd_complex_batch<batch<std::complex<double>, 4>> {
public:
...
namespace detail {
template<class B> inline std::pair<B, B> load_complex_f(const B& hi, const B& lo)
{
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
	B real = _mm256_castpd_ps(_mm256_permute4x64_pd(
	    _mm256_castps_pd(_mm256_shuffle_ps(hi, lo, _MM_SHUFFLE(2, 0, 2, 0))), _MM_SHUFFLE(3, 1, 2, 0)));
	B imag = _mm256_castpd_ps(_mm256_permute4x64_pd(
	    _mm256_castps_pd(_mm256_shuffle_ps(hi, lo, _MM_SHUFFLE(3, 1, 3, 1))), _MM_SHUFFLE(3, 1, 2, 0)));
...
template<int index, class B> inline B get_half_complex_f(const B& real, const B& imag)
{
...
template<class B> inline B get_complex_high_f(const B& real, const B& imag)
{
	return get_half_complex_f<0>(real, imag);
}

template<class B> inline B get_complex_low_f(const B& real, const B& imag) { return get_half_complex_f<1>(real, imag); }

template<class B> inline std::pair<B, B> load_complex_d(const B& hi, const B& lo)
{
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
...
// which require index parameter to be a constant
template<int index, class B> inline B get_half_complex_d(const B& real, const B& imag)
{
...
template<class B> inline B get_complex_high_d(const B& real, const B& imag)
{
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
...
template<class B> inline B get_complex_low_d(const B& real, const B& imag)
{
#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX2_VERSION
...
inline batch<std::complex<float>, 8>& batch<std::complex<float>, 8>::load_complex(const real_batch& hi,
    const real_batch& lo)
{
...
inline batch<std::complex<double>, 4>& batch<std::complex<double>, 4>::load_complex(const real_batch& hi,
    const real_batch& lo)
{
...
template<bool i3ec> inline auto batch<xtl::xcomplex<float, float, i3ec>, 8>::get_complex_high() const -> real_batch
{
	return detail::get_complex_high_f(this->m_real, this->m_imag);
}

template<bool i3ec> inline auto batch<xtl::xcomplex<float, float, i3ec>, 8>::get_complex_low() const -> real_batch
{
	return detail::get_complex_low_f(this->m_real, this->m_imag);
}
...
template<bool i3ec> inline auto batch<xtl::xcomplex<double, double, i3ec>, 4>::get_complex_high() const -> real_batch
{
	return detail::get_complex_high_d(this->m_real, this->m_imag);
}

template<bool i3ec> inline auto batch<xtl::xcomplex<double, double, i3ec>, 4>::get_complex_low() const -> real_batch
{
	return detail::get_complex_low_d(this->m_real, this->m_imag);
}
