...
template<>
struct simd_batch_traits<batch<std::complex<float>, 4>> : complex_batch_traits<std::complex<float>, float, 4, 16> {};
...
template<>
struct simd_batch_traits<batch<std::complex<double>, 2>> : complex_batch_traits<std::complex<double>, double, 2, 16> {};
...
inline batch<std::complex<float>, 4>& batch<std::complex<float>, 4>::load_complex(const real_batch& hi,
    const real_batch& lo)
{
...
inline batch<std::complex<double>, 2>& batch<std::complex<double>, 2>::load_complex(const real_batch& hi,
    const real_batch& lo)
{
...
template<bool i3ec> inline auto batch<xtl::xcomplex<float, float, i3ec>, 4>::get_complex_high() const -> real_batch
{
	return _mm_unpacklo_ps(this->m_real, this->m_imag);
}

template<bool i3ec> inline auto batch<xtl::xcomplex<float, float, i3ec>, 4>::get_complex_low() const -> real_batch
{
	return _mm_unpackhi_ps(this->m_real, this->m_imag);
}
...
template<bool i3ec> inline auto batch<xtl::xcomplex<double, double, i3ec>, 2>::get_complex_high() const -> real_batch
{
	return _mm_unpacklo_pd(this->m_real, this->m_imag);
}

template<bool i3ec> inline auto batch<xtl::xcomplex<double, double, i3ec>, 2>::get_complex_low() const -> real_batch
{
	return _mm_unpackhi_pd(this->m_real, this->m_imag);
}
