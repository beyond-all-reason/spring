...
template<> struct simd_batch_traits<batch_bool<int32_t, 16>> {
...
template<> struct simd_batch_traits<batch_bool<uint32_t, 16>> {
...
template<> class batch_bool<int32_t, 16> : public batch_bool_avx512<__mmask16, batch_bool<int32_t, 16>> {
public:
	using base_class = batch_bool_avx512<__mmask16, batch_bool<int32_t, 16>>;
	using base_class::base_class;
};

template<> class batch_bool<uint32_t, 16> : public batch_bool_avx512<__mmask16, batch_bool<uint32_t, 16>> {
public:
...
namespace detail {
template<> struct batch_bool_kernel<int32_t, 16> : batch_bool_kernel_avx512<int32_t, 16> {};

template<> struct batch_bool_kernel<uint32_t, 16> : batch_bool_kernel_avx512<uint32_t, 16> {};
} // namespace detail
...
template<> struct simd_batch_traits<batch<int32_t, 16>> {
	using value_type = int32_t;
	static constexpr std::size_t size = 16;
...
template<> struct simd_batch_traits<batch<uint32_t, 16>> {
	using value_type = uint32_t;
	static constexpr std::size_t size = 16;
...
template<> class batch<int32_t, 16> : public avx512_int_batch<int32_t, 16> {
public:
...
template<> class batch<uint32_t, 16> : public avx512_int_batch<uint32_t, 16> {
public:
...
namespace detail {
template<class T> struct avx512_int32_batch_kernel : avx512_int_kernel_base<batch<T, 16>> {
	using batch_type = batch<T, 16>;
	using value_type = T;
	using batch_bool_type = batch_bool<T, 16>;

	static batch_type neg(const batch_type& rhs) { return _mm512_sub_epi32(_mm512_setzero_si512(), rhs); }

	static batch_type add(const batch_type& lhs, const batch_type& rhs) { return _mm512_add_epi32(lhs, rhs); }

	static batch_type sub(const batch_type& lhs, const batch_type& rhs) { return _mm512_sub_epi32(lhs, rhs); }
	...
	static batch_type ssub(const batch_type& lhs, const batch_type& rhs) { return sadd(lhs, neg(rhs)); }

	static batch_type mul(const batch_type& lhs, const batch_type& rhs) { return _mm512_mullo_epi32(lhs, rhs); }
	...
	static batch_type bitwise_not(const batch_type& rhs) { return _mm512_xor_si512(rhs, _mm512_set1_epi32(-1)); }
	...
	static batch_type zip_lo(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpacklo_epi32(lhs, rhs); }

	static batch_type zip_hi(const batch_type& lhs, const batch_type& rhs) { return _mm512_unpackhi_epi32(lhs, rhs); }
};

template<> struct batch_kernel<int32_t, 16> : public avx512_int32_batch_kernel<int32_t> {
	using batch_type = batch<int32_t, 16>;
	using value_type = int32_t;
	using batch_bool_type = batch_bool<int32_t, 16>;
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm512_min_epi32(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm512_max_epi32(lhs, rhs); }

	static batch_type abs(const batch_type& rhs) { return _mm512_abs_epi32(rhs); }
};

template<> struct batch_kernel<uint32_t, 16> : public avx512_int32_batch_kernel<uint32_t> {
	using batch_type = batch<uint32_t, 16>;
	using value_type = uint32_t;
	using batch_bool_type = batch_bool<uint32_t, 16>;
	...
	static batch_type min(const batch_type& lhs, const batch_type& rhs) { return _mm512_min_epu32(lhs, rhs); }

	static batch_type max(const batch_type& lhs, const batch_type& rhs) { return _mm512_max_epu32(lhs, rhs); }
