...
#define XSIMD_VERSION_NUMBER_NOT_AVAILABLE XSIMD_VERSION_NUMBER(0, 0, 0)

#define XSIMD_VERSION_NUMBER_AVAILABLE XSIMD_VERSION_NUMBER(0, 0, 1)
...
// see https://www.gnu.org/software/gcc/gcc-6/changes.html
    ...
    (defined(__AVX512__) || defined(__KNCNI__) ||                                              \
        defined(__AVX512F__) && (defined(__clang__) || (!defined(__GNUC__) || __GNUC__ >= 6)))
