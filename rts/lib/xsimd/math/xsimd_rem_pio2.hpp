 ...
 */
#if defined(_MSC_VER)
#define ONCE0 __pragma(warning(push)) __pragma(warning(disable : 4127)) while (0) __pragma(warning(pop)) /**/
#else
...
inline int32_t __kernel_rem_pio2(double* x, double* y, int32_t e0, int32_t nx, int32_t prec, const int32_t* ipio2)
{
	...
	static const double PIo2[] = {
	    double(1.57079625129699707031e+00L), /* 0x3FF921FB, 0x40000000 */
	    double(7.54978941586159635335e-08L), /* 0x3E74442D, 0x00000000 */
	    double(5.39030252995776476554e-15L), /* 0x3CF84698, 0x80000000 */
	    double(3.28200341580791294123e-22L), /* 0x3B78CC51, 0x60000000 */
	    double(1.27065575308067607349e-29L), /* 0x39F01B83, 0x80000000 */
	    double(1.22933308981111328932e-36L), /* 0x387A2520, 0x40000000 */
	    double(2.73370053816464559624e-44L), /* 0x36E38222, 0x80000000 */
	    double(2.16741683877804819444e-51L), /* 0x3569F31D, 0x00000000 */
	};
