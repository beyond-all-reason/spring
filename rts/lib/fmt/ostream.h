...
template<typename Tag, typename BufType, FILE* BufType::* FileMemberPtr> class file_access {
...
/**
  ...
  **Example**::
  ...
  \endrst
 */
FMT_EXPORT template<typename... T> void print(std::ostream& os, format_string<T...> fmt, T&&... args)
{
...
FMT_EXPORT template<typename... T> void println(std::ostream& os, format_string<T...> fmt, T&&... args)
{
