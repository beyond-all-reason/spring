...
template<typename Char> FMT_CONSTEXPR ansi_color_escape<Char> make_emphasis(emphasis em) noexcept
{
...
template<typename T, typename Char> struct formatter<detail::styled_arg<T>, Char> : formatter<T, Char> {
...
/**
  ...
  **Example**::
  ...
  \endrst
 */
template<typename T> FMT_CONSTEXPR auto styled(const T& value, text_style ts) -> detail::styled_arg<remove_cvref_t<T>>
{
