...
template<typename Handler, typename... Values> class consign_handler {
public:
...
template<typename Handler> inline bool asio_handler_is_continuation(consign_handler<Handler>* this_handler)
{
...
struct associator<Associator, detail::consign_handler<Handler, Values...>, DefaultCandidate>
	...
	static auto get(const detail::consign_handler<Handler, Values...>& h, const DefaultCandidate& c) noexcept
