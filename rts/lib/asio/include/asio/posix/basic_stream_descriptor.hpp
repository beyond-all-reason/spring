 ...
 */
template<typename Executor = any_io_executor> class basic_stream_descriptor : public basic_descriptor<Executor> {
private:
...
public:
	...
	typedef typename basic_descriptor<Executor>::native_handle_type native_handle_type;
	 ...
	 */
	basic_stream_descriptor(const executor_type& ex, const native_handle_type& native_descriptor)
	...
	auto async_write_some(const ConstBufferSequence& buffers,
	    ...
	    -> decltype(async_initiate<WriteToken, void(asio::error_code, std::size_t)>(initiate_async_write_some(this),
	        token,
	        buffers))
	{
