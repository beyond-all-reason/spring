...
template<typename Protocol, typename Executor = any_io_executor> class basic_socket_acceptor;
...
public:
	...
	typedef typename detail::null_socket_service<Protocol>::native_handle_type native_handle_type;
#elif defined(ASIO_HAS_IOCP)
	typedef typename detail::win_iocp_socket_service<Protocol>::native_handle_type native_handle_type;
#elif defined(ASIO_HAS_IO_URING_AS_DEFAULT)
	typedef typename detail::io_uring_socket_service<Protocol>::native_handle_type native_handle_type;
#else
	...
	basic_socket_acceptor(ExecutionContext& context,
	    ...
	    constraint_t<is_convertible<ExecutionContext&, execution_context&>::value, defaulted_constraint> =
	    ...
	    : impl_(0, ex)
	{
		...
		asio::detail::throw_error(ec, "open");
		if (reuse_addr) {
			impl_.get_service().set_option(impl_.get_implementation(), socket_base::reuse_address(true), ec);
			asio::detail::throw_error(ec, "set_option");
		}
		impl_.get_service().bind(impl_.get_implementation(), endpoint, ec);
		asio::detail::throw_error(ec, "bind");
		impl_.get_service().listen(impl_.get_implementation(), socket_base::max_listen_connections, ec);
	...
	{
		asio::error_code ec;
		impl_.get_service().assign(impl_.get_implementation(), protocol, native_acceptor, ec);
	...
	template<typename Protocol1, typename Executor1> friend class basic_socket_acceptor;
	 ...
	 */
	template<typename Protocol1, typename Executor1>
	constraint_t<is_convertible<Protocol1, Protocol>::value && is_convertible<Executor1, Executor>::value,
	 ...
	 */
	ASIO_SYNC_OP_VOID
	assign(const protocol_type& protocol, const native_handle_type& native_acceptor, asio::error_code& ec)
	{
		impl_.get_service().assign(impl_.get_implementation(), protocol, native_acceptor, ec);
		ASIO_SYNC_OP_VOID_RETURN(ec);
	}
	...
	{
		asio::error_code ec;
		native_handle_type s = impl_.get_service().release(impl_.get_implementation(), ec);
	 ...
	 */
	native_handle_type native_handle() { return impl_.get_service().native_handle(impl_.get_implementation()); }
	 ...
	 * @endcode
	 */
	template<typename IoControlCommand> ASIO_SYNC_OP_VOID io_control(IoControlCommand& command, asio::error_code& ec)
	{
		impl_.get_service().io_control(impl_.get_implementation(), command, ec);
		ASIO_SYNC_OP_VOID_RETURN(ec);
	}
	 ...
	 */
	bool non_blocking() const { return impl_.get_service().non_blocking(impl_.get_implementation()); }
	 ...
	 */
	bool native_non_blocking() const { return impl_.get_service().native_non_blocking(impl_.get_implementation()); }
	...
	{
		asio::error_code ec;
		impl_.get_service().native_non_blocking(impl_.get_implementation(), mode, ec);
	...
	{
		asio::error_code ec;
		endpoint_type ep = impl_.get_service().local_endpoint(impl_.get_implementation(), ec);
	 ...
	 */
	template<ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code)) WaitToken = default_completion_token_t<executor_type>>
	auto async_wait(wait_type w, WaitToken&& token = default_completion_token_t<executor_type>())
	    -> decltype(async_initiate<WaitToken, void(asio::error_code)>(declval<initiate_async_wait>(), token, w))
	{
		return async_initiate<WaitToken, void(asio::error_code)>(initiate_async_wait(this), token, w);
	}
	 ...
	 */
	template<typename Protocol1, typename Executor1>
	void accept(basic_socket<Protocol1, Executor1>& peer, constraint_t<is_convertible<Protocol, Protocol1>::value> = 0)
	{
		asio::error_code ec;
		impl_.get_service().accept(impl_.get_implementation(), peer, static_cast<endpoint_type*>(0), ec);
	 ...
	 */
	template<typename Protocol1, typename Executor1>
	ASIO_SYNC_OP_VOID accept(basic_socket<Protocol1, Executor1>& peer,
	    asio::error_code& ec,
	...
	template<typename Protocol1,
	    typename Executor1,
	    ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code)) AcceptToken = default_completion_token_t<executor_type>>
	auto async_accept(basic_socket<Protocol1, Executor1>& peer,
	    AcceptToken&& token = default_completion_token_t<executor_type>(),
	    constraint_t<is_convertible<Protocol, Protocol1>::value> = 0)
	    -> decltype(async_initiate<AcceptToken, void(asio::error_code)>(declval<initiate_async_accept>(),
	        token,
	        &peer,
	        static_cast<endpoint_type*>(0)))
	{
		return async_initiate<AcceptToken, void(asio::error_code)>(
		    initiate_async_accept(this), token, &peer, static_cast<endpoint_type*>(0));
	}
	...
	{
		asio::error_code ec;
		impl_.get_service().accept(impl_.get_implementation(), peer, &peer_endpoint, ec);
		asio::detail::throw_error(ec, "accept");
	}
	...
	ASIO_SYNC_OP_VOID
	accept(basic_socket<protocol_type, Executor1>& peer, endpoint_type& peer_endpoint, asio::error_code& ec)
	{
		impl_.get_service().accept(impl_.get_implementation(), peer, &peer_endpoint, ec);
		ASIO_SYNC_OP_VOID_RETURN(ec);
	}
	 ...
	 * @endcode
	 */
	typename Protocol::socket::template rebind_executor<executor_type>::other accept()
	{
		asio::error_code ec;
		typename Protocol::socket::template rebind_executor<executor_type>::other peer(impl_.get_executor());
	 ...
	 * @endcode
	 */
	typename Protocol::socket::template rebind_executor<executor_type>::other accept(asio::error_code& ec)
	{
		typename Protocol::socket::template rebind_executor<executor_type>::other peer(impl_.get_executor());
		impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
		return peer;
	...
	template<ASIO_COMPLETION_TOKEN_FOR(
	             void(asio::error_code, typename Protocol::socket::template rebind_executor<executor_type>::other))
	             MoveAcceptToken = default_completion_token_t<executor_type>>
	auto async_accept(MoveAcceptToken&& token = default_completion_token_t<executor_type>())
	    -> decltype(async_initiate<MoveAcceptToken,
	        void(asio::error_code, typename Protocol::socket::template rebind_executor<executor_type>::other)>(
	        declval<initiate_async_move_accept>(),
	        token,
	        declval<const executor_type&>(),
	        static_cast<endpoint_type*>(0),
	        static_cast<typename Protocol::socket::template rebind_executor<executor_type>::other*>(0)))
	{
		return async_initiate<MoveAcceptToken,
		    void(asio::error_code, typename Protocol::socket::template rebind_executor<executor_type>::other)>(
		    initiate_async_move_accept(this), token, impl_.get_executor(), static_cast<endpoint_type*>(0),
		    static_cast<typename Protocol::socket::template rebind_executor<executor_type>::other*>(0));
	}
	...
	{
		asio::error_code ec;
		typename Protocol::socket::template rebind_executor<Executor1>::other peer(ex);
		impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
		asio::detail::throw_error(ec, "accept");
		return peer;
	}
	...
	accept(ExecutionContext& context, constraint_t<is_convertible<ExecutionContext&, execution_context&>::value> = 0)
	{
		asio::error_code ec;
		typename Protocol::socket::template rebind_executor<typename ExecutionContext::executor_type>::other peer(
		    context);
		impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
		asio::detail::throw_error(ec, "accept");
		return peer;
	 ...
	 */
	template<typename ExecutionContext>
	typename Protocol::socket::template rebind_executor<typename ExecutionContext::executor_type>::other accept(
	...
	template<typename Executor1,
	    ASIO_COMPLETION_TOKEN_FOR(void(asio::error_code,
	        typename Protocol::socket::template rebind_executor<
	            constraint_t<is_executor<Executor1>::value || execution::is_executor<Executor1>::value,
	                Executor1>>::other)) MoveAcceptToken = default_completion_token_t<executor_type>>
	auto async_accept(const Executor1& ex,
	    ...
	    -> decltype(async_initiate<MoveAcceptToken,
	        ...
	        ex,
	        static_cast<endpoint_type*>(0),
	        static_cast<typename Protocol::socket::template rebind_executor<Executor1>::other*>(0)))
	{
		return async_initiate<MoveAcceptToken,
		    void(asio::error_code, typename Protocol::socket::template rebind_executor<Executor1>::other)>(
		    initiate_async_move_accept(this), token, ex, static_cast<endpoint_type*>(0),
		    static_cast<typename Protocol::socket::template rebind_executor<Executor1>::other*>(0));
	}
	            ...
	            0)))
	{
		return async_initiate<MoveAcceptToken,
		    void(asio::error_code,
		        typename Protocol::socket::template rebind_executor<typename ExecutionContext::executor_type>::other)>(
		    initiate_async_move_accept(this), token, context.get_executor(), static_cast<endpoint_type*>(0),
		    static_cast<
		        typename Protocol::socket::template rebind_executor<typename ExecutionContext::executor_type>::other*>(
		        0));
	}
	 ...
	 * @endcode
	 */
	typename Protocol::socket::template rebind_executor<executor_type>::other accept(endpoint_type& peer_endpoint)
	{
		asio::error_code ec;
		typename Protocol::socket::template rebind_executor<executor_type>::other peer(impl_.get_executor());
		impl_.get_service().accept(impl_.get_implementation(), peer, &peer_endpoint, ec);
	        ...
	        static_cast<typename Protocol::socket::template rebind_executor<executor_type>::other*>(0)))
	{
		return async_initiate<MoveAcceptToken,
		    void(asio::error_code, typename Protocol::socket::template rebind_executor<executor_type>::other)>(
		    initiate_async_move_accept(this), token, impl_.get_executor(), &peer_endpoint,
		    static_cast<typename Protocol::socket::template rebind_executor<executor_type>::other*>(0));
	}
	 ...
	 */
	template<typename Executor1>
	typename Protocol::socket::template rebind_executor<Executor1>::other accept(const executor_type& ex,
	    endpoint_type& peer_endpoint,
	    asio::error_code& ec,
	    constraint_t<is_executor<Executor1>::value || execution::is_executor<Executor1>::value> = 0)
	{
	            ...
	            0)))
	{
		return async_initiate<MoveAcceptToken,
		    void(asio::error_code,
		        typename Protocol::socket::template rebind_executor<typename ExecutionContext::executor_type>::other)>(
		    initiate_async_move_accept(this), token, context.get_executor(), &peer_endpoint,
		    static_cast<
		        typename Protocol::socket::template rebind_executor<typename ExecutionContext::executor_type>::other*>(
		        0));
	}
...
private:
	...
	public:
		...
		const executor_type& get_executor() const noexcept { return self_->get_executor(); }

		template<typename WaitHandler> void operator()(WaitHandler&& handler, wait_type w) const
		{
			...
			self_->impl_.get_service().async_wait(
			    self_->impl_.get_implementation(), w, handler2.value, self_->impl_.get_executor());
		}
	...
	public:
		    ...
		    endpoint_type* peer_endpoint) const
		{
			...
			self_->impl_.get_service().async_accept(
			    self_->impl_.get_implementation(), *peer, peer_endpoint, handler2.value, self_->impl_.get_executor());
		}
	...
	public:
		...
		void
		operator()(MoveAcceptHandler&& handler, const Executor1& peer_ex, endpoint_type* peer_endpoint, Socket*) const
		{
			// If you get an error on the following line it means that your handler
			// does not meet the documented type requirements for a MoveAcceptHandler.
			ASIO_MOVE_ACCEPT_HANDLER_CHECK(MoveAcceptHandler, handler, Socket) type_check;

			detail::non_const_lvalue<MoveAcceptHandler> handler2(handler);
			self_->impl_.get_service().async_move_accept(
			    self_->impl_.get_implementation(), peer_ex, peer_endpoint, handler2.value, self_->impl_.get_executor());
		}
...
#if defined(ASIO_WINDOWS_RUNTIME)
	detail::io_object_impl<detail::null_socket_service<Protocol>, Executor> impl_;
#elif defined(ASIO_HAS_IOCP)
	detail::io_object_impl<detail::win_iocp_socket_service<Protocol>, Executor> impl_;
#elif defined(ASIO_HAS_IO_URING_AS_DEFAULT)
	detail::io_object_impl<detail::io_uring_socket_service<Protocol>, Executor> impl_;
#else
