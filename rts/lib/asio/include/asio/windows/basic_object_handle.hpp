...
public:
	 ...
	 */
	basic_object_handle(const executor_type& ex, const native_handle_type& native_handle)
	    : impl_(0, ex)
	{
		asio::error_code ec;
	 ...
	 */
	ASIO_SYNC_OP_VOID assign(const native_handle_type& handle, asio::error_code& ec)
	{
		impl_.get_service().assign(impl_.get_implementation(), handle, ec);
...
private:
	...
	asio::detail::io_object_impl<asio::detail::win_object_handle_service, Executor> impl_;
};
