...
public:
	...
	template<typename Allocator, unsigned int Bits> friend class basic_executor_type;
...
template<typename Allocator, unsigned int Bits> class thread_pool::basic_executor_type : detail::thread_pool_bits {
public:
	/// Copy constructor.
...
private:
	 ...
	 */
	constexpr basic_executor_type<Allocator, ASIO_UNSPECIFIED(Bits & ~blocking_mask)> require(
	    execution::blocking_t::possibly_t) const
	{
		return basic_executor_type<Allocator, Bits & ~blocking_mask>(pool_, allocator_, bits_ & ~blocking_mask);
	}
	 ...
	 */
	constexpr basic_executor_type<Allocator, ASIO_UNSPECIFIED((Bits & ~blocking_mask) | blocking_always)> require(
	    execution::blocking_t::always_t) const
	{
		return basic_executor_type<Allocator, ASIO_UNSPECIFIED((Bits & ~blocking_mask) | blocking_always)>(
	...
	{
		return basic_executor_type(pool_, allocator_, bits_ & ~relationship_continuation);
	}
	 ...
	 */
	constexpr basic_executor_type require(execution::relationship_t::continuation_t) const
	{
		return basic_executor_type(pool_, allocator_, bits_ | relationship_continuation);
	}
	 ...
	 */
	constexpr basic_executor_type<Allocator, ASIO_UNSPECIFIED(Bits | outstanding_work_tracked)> require(
	    execution::outstanding_work_t::tracked_t) const
	{
		return basic_executor_type<Allocator, Bits | outstanding_work_tracked>(pool_, allocator_, bits_);
	}
	...
	constexpr basic_executor_type<OtherAllocator, Bits> require(execution::allocator_t<OtherAllocator> a) const
	{
	...
	{
		return basic_executor_type<std::allocator<void>, Bits>(pool_, std::allocator<void>(), bits_);
	}
...
private:
	 ...
	 *   ... @endcode
	 */
	static constexpr execution::mapping_t query(execution::mapping_t) noexcept { return execution::mapping.thread; }
	...
	constexpr execution::blocking_t query(execution::blocking_t) const noexcept
	{
		return (bits_ & blocking_never) ?
		           ...
		           ((Bits & blocking_always) ? execution::blocking_t(execution::blocking.always) :
	 ...
	 *   ... @endcode
	 */
	constexpr execution::relationship_t query(execution::relationship_t) const noexcept
	{
		return (bits_ & relationship_continuation) ? execution::relationship_t(execution::relationship.continuation) :
	...
	{
		return (Bits & outstanding_work_tracked) ? execution::outstanding_work_t(execution::outstanding_work.tracked) :
	 ...
	 *     asio::execution::allocator); @endcode
	 */
	template<typename OtherAllocator> constexpr Allocator query(execution::allocator_t<OtherAllocator>) const noexcept
	{
		return allocator_;
	}
	 ...
	 *     asio::execution::allocator); @endcode
	 */
	constexpr Allocator query(execution::allocator_t<void>) const noexcept { return allocator_; }
	 ...
	 */
	std::size_t query(execution::occupancy_t) const noexcept { return static_cast<std::size_t>(pool_->num_threads_); }
...
public:
	...
	{
		this->do_execute(static_cast<Function&&>(f), integral_constant<bool, (Bits & blocking_always) != 0>());
	}
...
public:
	 ...
	 */
	template<typename Function, typename OtherAllocator> void dispatch(Function&& f, const OtherAllocator& a) const;
...
private:
	...
	basic_executor_type(thread_pool* p, const Allocator& a, unsigned int bits) noexcept
	    : pool_(p)
	    , allocator_(a)
	    , bits_(bits)
	{
...
struct equality_comparable<asio::thread_pool::basic_executor_type<Allocator, Bits>> {
...
struct execute_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, Function> {
	static constexpr bool is_valid = true;
...
template<typename Allocator, unsigned int Bits>
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::blocking_t::possibly_t>
    : asio::detail::thread_pool_bits {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
	typedef asio::thread_pool::basic_executor_type<Allocator, Bits & ~blocking_mask> result_type;
};

template<typename Allocator, unsigned int Bits>
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::blocking_t::always_t>
    : asio::detail::thread_pool_bits {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::thread_pool::basic_executor_type<Allocator, (Bits & ~blocking_mask) | blocking_always> result_type;
};

template<typename Allocator, unsigned int Bits>
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::blocking_t::never_t>
    : asio::detail::thread_pool_bits {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::thread_pool::basic_executor_type<Allocator, Bits & ~blocking_mask> result_type;
...
template<typename Allocator, unsigned int Bits>
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
    asio::execution::outstanding_work_t::tracked_t> : asio::detail::thread_pool_bits {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::thread_pool::basic_executor_type<Allocator, Bits | outstanding_work_tracked> result_type;
};

template<typename Allocator, unsigned int Bits>
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
    asio::execution::outstanding_work_t::untracked_t> : asio::detail::thread_pool_bits {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::thread_pool::basic_executor_type<Allocator, Bits & ~outstanding_work_tracked> result_type;
};
...
template<typename Allocator, unsigned int Bits>
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::allocator_t<void>> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::thread_pool::basic_executor_type<std::allocator<void>, Bits> result_type;
};
...
struct require_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
	...
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::thread_pool::basic_executor_type<OtherAllocator, Bits> result_type;
};
...
struct query_static_constexpr_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
    Property,
    typename asio::enable_if<asio::is_convertible<Property, asio::execution::outstanding_work_t>::value>::type>
    : asio::detail::thread_pool_bits {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
...
struct query_static_constexpr_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
    Property,
    typename asio::enable_if<asio::is_convertible<Property, asio::execution::mapping_t>::value>::type> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
...
struct query_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
    Property,
    typename asio::enable_if<asio::is_convertible<Property, asio::execution::blocking_t>::value>::type> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
...
struct query_member<asio::thread_pool::basic_executor_type<Allocator, Bits>,
    Property,
    typename asio::enable_if<asio::is_convertible<Property, asio::execution::relationship_t>::value>::type> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
...
template<typename Allocator, unsigned int Bits>
struct query_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::occupancy_t> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
...
template<typename Allocator, unsigned int Bits>
struct query_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::context_t> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
...
template<typename Allocator, unsigned int Bits>
struct query_member<asio::thread_pool::basic_executor_type<Allocator, Bits>, asio::execution::allocator_t<void>> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
