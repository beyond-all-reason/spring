...
public:
	...
	address_v6 address() const noexcept { return address_; }
	...
	bool is_host() const noexcept { return prefix_length_ == 128; }
	...
	friend bool operator!=(const network_v6& a, const network_v6& b) { return !(a == b); }
 ...
 * @relates address_v6
 */
inline network_v6 make_network_v6(const address_v6& addr, unsigned short prefix_len)
{
 ...
 * @relates network_v6
 */
ASIO_DECL network_v6 make_network_v6(string_view str, asio::error_code& ec);
