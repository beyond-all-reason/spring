...
public:
	 ...
	 */
	ASIO_DECL explicit address_v6(const bytes_type& bytes, scope_id_type scope_id = 0);
	...
	ASIO_DECL address_v6& operator=(const address_v6& other) noexcept;
	...
	ASIO_DECL friend bool operator==(const address_v6& a1, const address_v6& a2) noexcept;

	/// Compare two addresses for inequality.
	friend bool operator!=(const address_v6& a1, const address_v6& a2) noexcept { return !(a1 == a2); }

	/// Compare addresses for ordering.
	ASIO_DECL friend bool operator<(const address_v6& a1, const address_v6& a2) noexcept;

	/// Compare addresses for ordering.
	friend bool operator>(const address_v6& a1, const address_v6& a2) noexcept { return a2 < a1; }
 ...
 * @relates address_v6
 */
ASIO_DECL address_v6 make_address_v6(const char* str, asio::error_code& ec) noexcept;
 ...
 * @relates address_v6
 */
ASIO_DECL address_v6 make_address_v6(const std::string& str, asio::error_code& ec) noexcept;
 ...
 * @relates address_v6
 */
ASIO_DECL address_v6 make_address_v6(string_view str, asio::error_code& ec) noexcept;
...
template<> struct hash<asio::ip::address_v6> {
