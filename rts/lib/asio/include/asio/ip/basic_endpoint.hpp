...
public:
	 ...
	 * @endcode
	 */
	basic_endpoint(const InternetProtocol& internet_protocol, port_type port_num) noexcept
...
template<typename InternetProtocol> struct hash<asio::ip::basic_endpoint<InternetProtocol>> {
