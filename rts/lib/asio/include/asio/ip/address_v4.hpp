...
public:
	 ...
	 */
	friend bool operator<(const address_v4& a1, const address_v4& a2) noexcept { return a1.to_uint() < a2.to_uint(); }
	...
	/// address and netmask.
	ASIO_DECL static address_v4 broadcast(const address_v4& addr, const address_v4& mask);
 ...
 * @relates address_v4
 */
inline address_v4 make_address_v4(const address_v4::bytes_type& bytes) { return address_v4(bytes); }

/// Create an IPv4 address from an unsigned integer in host byte order.
/**
 * @relates address_v4
 */
inline address_v4 make_address_v4(address_v4::uint_type addr) { return address_v4(addr); }
 ...
 * @relates address_v4
 */
ASIO_DECL address_v4 make_address_v4(const char* str, asio::error_code& ec) noexcept;
 ...
 * @relates address_v4
 */
ASIO_DECL address_v4 make_address_v4(const std::string& str, asio::error_code& ec) noexcept;
 ...
 * @relates address_v4
 */
ASIO_DECL address_v4 make_address_v4(string_view str, asio::error_code& ec) noexcept;
