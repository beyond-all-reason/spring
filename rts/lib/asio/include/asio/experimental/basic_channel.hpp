...
class basic_channel
    ...
    : public detail::channel_send_functions<basic_channel<Executor, Traits, Signatures...>, Executor, Signatures...>
...
public:
	...
	basic_channel(const executor_type& ex, std::size_t max_buffer_size = 0)
	    : service_(&asio::use_service<service_type>(basic_channel::get_context(ex)))
	    , impl_()
	    , executor_(ex)
	{
	...
	basic_channel(ExecutionContext& context,
