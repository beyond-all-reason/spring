...
template<typename R, typename Arg0, typename Arg1> class channel_message<R(Arg0, Arg1)> {
public:
	...
	template<typename Handler> void receive(Handler& handler)
	{
		static_cast<Handler&&>(handler)(static_cast<arg0_type&&>(arg0_), static_cast<arg1_type&&>(arg1_));
	}
...
private:
	template<typename Handler, std::size_t... I> void do_receive(Handler& h, asio::detail::index_sequence<I...>)
	{
		static_cast<Handler&&>(h)(std::get<I>(static_cast<args_type&&>(args_))...);
	}
