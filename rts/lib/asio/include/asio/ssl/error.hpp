...
static const asio::error_category& ssl_category ASIO_UNUSED_VARIABLE = asio::error::get_ssl_category();
...
#if (OPENSSL_VERSION_NUMBER < 0x10100000L) && !defined(OPENSSL_IS_BORINGSSL) && !defined(ASIO_USE_WOLFSSL)
