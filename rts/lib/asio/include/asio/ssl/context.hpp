...
public:
	 ...
	 * @note Calls @c SSL_CTX_clear_options.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID clear_options(options o, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_set_options.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID set_options(options o, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_set_verify.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID set_verify_mode(verify_mode v, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_set_verify_depth.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID set_verify_depth(int depth, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_load_verify_locations.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID load_verify_file(const std::string& filename, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID add_certificate_authority(const const_buffer& ca, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_set_default_verify_paths.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID set_default_verify_paths(asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_load_verify_locations.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID add_verify_path(const std::string& path, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_certificate(const const_buffer& certificate,
	    file_format format,
	    asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_certificate_file.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_certificate_file(const std::string& filename,
	    file_format format,
	    asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_certificate and SSL_CTX_add_extra_chain_cert.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_certificate_chain(const const_buffer& chain, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_certificate_chain_file.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_certificate_chain_file(const std::string& filename, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_private_key(const const_buffer& private_key,
	    file_format format,
	    asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_PrivateKey_file.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_private_key_file(const std::string& filename,
	    file_format format,
	    asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_rsa_private_key(const const_buffer& private_key,
	    file_format format,
	    asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_rsa_private_key_file(const std::string& filename,
	    file_format format,
	    asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_set_tmp_dh.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_tmp_dh(const const_buffer& dh, asio::error_code& ec);
	 ...
	 * @note Calls @c SSL_CTX_set_tmp_dh.
	 */
	ASIO_DECL ASIO_SYNC_OP_VOID use_tmp_dh_file(const std::string& filename, asio::error_code& ec);
...
private:
	...
	ASIO_DECL ASIO_SYNC_OP_VOID do_set_verify_callback(detail::verify_callback_base* callback, asio::error_code& ec);
	...
	ASIO_DECL ASIO_SYNC_OP_VOID do_set_password_callback(detail::password_callback_base* callback,
	    asio::error_code& ec);
	...
	ASIO_DECL ASIO_SYNC_OP_VOID do_use_tmp_dh(BIO* bio, asio::error_code& ec);
