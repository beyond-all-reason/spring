...
class handshake_op {
public:
	static constexpr const char* tracking_name() { return "ssl::stream<>::async_handshake"; }
	...
	template<typename Handler> void call_handler(Handler& handler, const asio::error_code& ec, const std::size_t&) const
	{
