...
private:
	...
	{
		return basic_system_executor<execution::blocking_t::possibly_t, Relationship, Allocator>(allocator_);
	}
	...
	{
		return basic_system_executor<execution::blocking_t::always_t, Relationship, Allocator>(allocator_);
	}
	...
	{
		return basic_system_executor<execution::blocking_t::never_t, Relationship, Allocator>(allocator_);
	}
	...
	{
		return basic_system_executor<Blocking, execution::relationship_t::continuation_t, Allocator>(allocator_);
	}
	...
	{
		return basic_system_executor<Blocking, execution::relationship_t::fork_t, Allocator>(allocator_);
	}
	...
	{
		return basic_system_executor<Blocking, Relationship, OtherAllocator>(a.value());
	}
	 ...
	 */
	basic_system_executor<Blocking, Relationship, std::allocator<void>> require(execution::allocator_t<void>) const
	{
		return basic_system_executor<Blocking, Relationship, std::allocator<void>>();
	}
...
private:
	 ...
	 *   ... @endcode
	 */
	static constexpr execution::blocking_t query(execution::blocking_t) noexcept { return Blocking(); }
	 ...
	 *   ... @endcode
	 */
	static constexpr execution::relationship_t query(execution::relationship_t) noexcept { return Relationship(); }
...
public:
	 ...
	 */
	friend bool operator==(const basic_system_executor&, const basic_system_executor&) noexcept { return true; }

	/// Compare two executors for inequality.
	/**
	 * Two executors are equal if they refer to the same underlying io_context.
	 */
	friend bool operator!=(const basic_system_executor&, const basic_system_executor&) noexcept { return false; }
...
private:
	...
	template<typename Function> void do_execute(Function&& f, execution::blocking_t::possibly_t) const;

	/// Execution helper implementation for the always blocking property.
	template<typename Function> void do_execute(Function&& f, execution::blocking_t::always_t) const;

	/// Execution helper implementation for the never blocking property.
	template<typename Function> void do_execute(Function&& f, execution::blocking_t::never_t) const;
...
struct equality_comparable<asio::basic_system_executor<Blocking, Relationship, Allocator>> {
...
struct execute_member<asio::basic_system_executor<Blocking, Relationship, Allocator>, Function> {
	static constexpr bool is_valid = true;
...
template<typename Blocking, typename Relationship, typename Allocator>
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
    asio::execution::blocking_t::possibly_t> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<asio::execution::blocking_t::possibly_t, Relationship, Allocator> result_type;
};
...
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
	...
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<asio::execution::blocking_t::always_t, Relationship, Allocator> result_type;
};
...
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
	...
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<asio::execution::blocking_t::never_t, Relationship, Allocator> result_type;
};
...
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
	...
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<Blocking, asio::execution::relationship_t::fork_t, Allocator> result_type;
};
...
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
	...
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<Blocking, asio::execution::relationship_t::continuation_t, Allocator>
	    result_type;
};
...
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
	...
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<Blocking, Relationship, std::allocator<void>> result_type;
};

template<typename Blocking, typename Relationship, typename Allocator, typename OtherAllocator>
struct require_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
    asio::execution::allocator_t<OtherAllocator>> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = false;
	typedef asio::basic_system_executor<Blocking, Relationship, OtherAllocator> result_type;
};
...
template<typename Blocking, typename Relationship, typename Allocator, typename Property>
struct query_static_constexpr_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
    Property,
...
template<typename Blocking, typename Relationship, typename Allocator, typename Property>
struct query_member<asio::basic_system_executor<Blocking, Relationship, Allocator>,
    Property,
...
template<typename Blocking, typename Relationship, typename Allocator>
struct query_member<asio::basic_system_executor<Blocking, Relationship, Allocator>, asio::execution::context_t> {
	static constexpr bool is_valid = true;
	static constexpr bool is_noexcept = true;
