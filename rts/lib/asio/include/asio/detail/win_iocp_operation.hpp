...
class win_iocp_operation : public OVERLAPPED ASIO_ALSO_INHERIT_TRACKED_HANDLER {
public:
	...
	void destroy() { func_(0, this, asio::error_code(), 0); }
...
protected:
	typedef void (*func_type)(void*, win_iocp_operation*, const asio::error_code&, std::size_t);
