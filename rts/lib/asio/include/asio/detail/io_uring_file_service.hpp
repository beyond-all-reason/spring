...
#if defined(ASIO_HAS_FILE) && defined(ASIO_HAS_IO_URING)
...
class io_uring_file_service : public execution_context_service_base<io_uring_file_service> {
public:
	...
	void move_assign(implementation_type& impl, io_uring_file_service& other_service, implementation_type& other_impl)
	{
	...
	void async_write_some_at(implementation_type& impl,
	    ...
	    const IoExecutor& io_ex)
	{
		descriptor_service_.async_write_some_at(impl, offset, buffers, handler, io_ex);
	}
	...
	void async_read_some_at(implementation_type& impl,
	    ...
	    const IoExecutor& io_ex)
	{
		descriptor_service_.async_read_some_at(impl, offset, buffers, handler, io_ex);
	}
