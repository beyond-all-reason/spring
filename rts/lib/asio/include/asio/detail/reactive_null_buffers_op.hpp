...
template<typename Handler, typename IoExecutor> class reactive_null_buffers_op : public reactor_op {
public:
	...
	reactive_null_buffers_op(const asio::error_code& success_ec, Handler& handler, const IoExecutor& io_ex)
	    : reactor_op(success_ec, &reactive_null_buffers_op::do_perform, &reactive_null_buffers_op::do_complete)
