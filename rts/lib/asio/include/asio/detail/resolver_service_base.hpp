...
public:
	...
	ASIO_DECL void
	move_assign(implementation_type& impl, resolver_service_base& other_service, implementation_type& other_impl);
...
protected:
	...
	class auto_addrinfo : private asio::detail::noncopyable {
	public:
		...
		operator asio::detail::addrinfo_type*() { return ai_; }
