...
class win_object_handle_service : public execution_context_service_base<win_object_handle_service> {
public:
	...
	ASIO_DECL void
	move_assign(implementation_type& impl, win_object_handle_service& other_service, implementation_type& other_impl);
	...
	void async_wait(implementation_type& impl, Handler& handler, const IoExecutor& io_ex)
	{
		...
		ASIO_HANDLER_CREATION((scheduler_.context(), *p.p, "object_handle", &impl,
		    reinterpret_cast<uintmax_t>(impl.wait_handle_), "async_wait"));
