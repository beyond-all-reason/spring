...
public:
	...
	static void execute(const implementation_type& impl,
	    Executor& ex,
	    Function&& function,
	    enable_if_t<can_query<Executor, execution::allocator_t<void>>::value>* = 0);
...
private:
	...
	ASIO_DECL static bool enqueue(const implementation_type& impl, scheduler_operation* op);
	...
	template<typename Executor, typename Function, typename Allocator>
	static void do_execute(const implementation_type& impl, Executor& ex, Function&& function, const Allocator& a);
