...
#define ASIO_CONCURRENCY_HINT_IS_SPECIAL(hint)                                                  \
	((static_cast<unsigned>(hint) & ASIO_CONCURRENCY_HINT_ID_MASK) == ASIO_CONCURRENCY_HINT_ID)
...
#define ASIO_CONCURRENCY_HINT_IS_LOCKING(facility, hint)                                                           \
	(((static_cast<unsigned>(hint) & (ASIO_CONCURRENCY_HINT_ID_MASK | ASIO_CONCURRENCY_HINT_LOCKING_##facility)) ^ \
...
#define ASIO_CONCURRENCY_HINT_UNSAFE static_cast<int>(ASIO_CONCURRENCY_HINT_ID)
...
#define ASIO_CONCURRENCY_HINT_UNSAFE_IO                                                   \
	static_cast<int>(ASIO_CONCURRENCY_HINT_ID | ASIO_CONCURRENCY_HINT_LOCKING_SCHEDULER | \
...
#define ASIO_CONCURRENCY_HINT_SAFE                                                                                  \
	static_cast<int>(ASIO_CONCURRENCY_HINT_ID | ASIO_CONCURRENCY_HINT_LOCKING_SCHEDULER |                           \
	                 ASIO_CONCURRENCY_HINT_LOCKING_REACTOR_REGISTRATION | ASIO_CONCURRENCY_HINT_LOCKING_REACTOR_IO)
