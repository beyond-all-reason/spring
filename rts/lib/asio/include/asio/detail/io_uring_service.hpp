...
class io_uring_service : public execution_context_service_base<io_uring_service>, public scheduler_task {
private:
...
public:
	...
	ASIO_DECL void register_internal_io_object(io_object*& io_obj, int op_type, io_uring_operation* op);
	...
	ASIO_DECL void start_op(int op_type, per_io_object_data& io_obj, io_uring_operation* op, bool is_continuation);
	...
	ASIO_DECL void cancel_ops_by_key(per_io_object_data& io_obj, int op_type, void* cancellation_key);
...
private:
	...
	ASIO_DECL bool do_cancel_ops(per_io_object_data& io_obj, op_queue<operation>& ops);
