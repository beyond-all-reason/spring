...
public:
	reactive_socket_connect_op_base(const asio::error_code& success_ec, socket_type socket, func_type complete_func)
	    : reactor_op(success_ec, &reactive_socket_connect_op_base::do_perform, complete_func)
	    , socket_(socket)
	{
	}
	...
	static status do_perform(reactor_op* base)
	{
		...
		status result = socket_ops::non_blocking_connect(o->socket_, o->ec_) ? done : not_done;
...
public:
	...
	reactive_socket_connect_op(const asio::error_code& success_ec,
	    ...
	    : reactive_socket_connect_op_base(success_ec, socket, &reactive_socket_connect_op::do_complete)
