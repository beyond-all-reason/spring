...
template<typename Handler> void strand_service::dispatch(strand_service::implementation_type& impl, Handler& handler)
{
	...
	ASIO_HANDLER_CREATION((this->context(), *p.p, "strand", impl, 0, "dispatch"));
...
template<typename Handler> void strand_service::post(strand_service::implementation_type& impl, Handler& handler)
{
	...
	ASIO_HANDLER_CREATION((this->context(), *p.p, "strand", impl, 0, "post"));
