...
template<typename CompletionCondition> class base_from_completion_cond {
protected:
	...
	{
		return detail::adapt_completion_condition_result(completion_condition_(ec, total_transferred));
	}
...
template<> class base_from_completion_cond<transfer_all_t> {
protected:
