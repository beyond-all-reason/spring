...
public:
	...
	std::size_t capacity() const { return sizeof(asio::detail::sockaddr_storage_type); }
...
private:
	...
	ASIO_DECL void init(const void* sock_addr, std::size_t sock_addr_size, int sock_protocol);
};
