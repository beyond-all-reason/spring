...
static void pusherror(lua_State* L)
{
	...
	char buffer[128];
	if (FormatMessageA(
	        FORMAT_MESSAGE_IGNORE_INSERTS | FORMAT_MESSAGE_FROM_SYSTEM, NULL, error, 0, buffer, sizeof(buffer), NULL))
...
static void** ll_register(lua_State* L, const char* path)
{
	...
	lua_gettable(L, LUA_REGISTRYINDEX); /* check library in lua_registry? */
