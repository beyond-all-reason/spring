...
#define SET_OPCODE(i, o)                                                                                       \
	((i) = (((i) & MASK0(SIZE_OP, POS_OP)) | ((lua_cast(Instruction, o) << POS_OP) & MASK1(SIZE_OP, POS_OP))))

#define GETARG_A(i) (lua_cast(int, ((i) >> POS_A) & MASK1(SIZE_A, 0)))
#define SETARG_A(i, u)                                                                                    \
	((i) = (((i) & MASK0(SIZE_A, POS_A)) | ((lua_cast(Instruction, u) << POS_A) & MASK1(SIZE_A, POS_A))))

#define GETARG_B(i) (lua_cast(int, ((i) >> POS_B) & MASK1(SIZE_B, 0)))
#define SETARG_B(i, b)                                                                                    \
	((i) = (((i) & MASK0(SIZE_B, POS_B)) | ((lua_cast(Instruction, b) << POS_B) & MASK1(SIZE_B, POS_B))))

#define GETARG_C(i) (lua_cast(int, ((i) >> POS_C) & MASK1(SIZE_C, 0)))
#define SETARG_C(i, b)                                                                                    \
	((i) = (((i) & MASK0(SIZE_C, POS_C)) | ((lua_cast(Instruction, b) << POS_C) & MASK1(SIZE_C, POS_C))))

#define GETARG_Bx(i) (lua_cast(int, ((i) >> POS_Bx) & MASK1(SIZE_Bx, 0)))
#define SETARG_Bx(i, b)                                                                                        \
	((i) = (((i) & MASK0(SIZE_Bx, POS_Bx)) | ((lua_cast(Instruction, b) << POS_Bx) & MASK1(SIZE_Bx, POS_Bx))))
...
#define CREATE_ABC(o, a, b, c)                                                     \
	((lua_cast(Instruction, o) << POS_OP) | (lua_cast(Instruction, a) << POS_A) |  \
	    (lua_cast(Instruction, b) << POS_B) | (lua_cast(Instruction, c) << POS_C))

#define CREATE_ABx(o, a, bc) \
	((lua_cast(Instruction, o) << POS_OP) | (lua_cast(Instruction, a) << POS_A) | (lua_cast(Instruction, bc) << POS_Bx))
