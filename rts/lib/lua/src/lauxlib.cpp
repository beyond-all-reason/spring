...
LUALIB_API lua_Number luaL_checknumber(lua_State* L, int narg)
{
	...
	if unlikely (math::isinf(d))
		luaL_argerror(L, narg, "number expected, got +-Inf (check your code for div0)");
	if unlikely (math::isnan(d))
		luaL_argerror(L, narg, "number expected, got +-NaN (check your code for div0)");
#endif
