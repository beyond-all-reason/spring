...
extern DECLSPEC void SDLCALL SDL_free(void *p) { return; }
...
extern DECLSPEC struct SDL_RWops *SDLCALL SDL_RWFromFile(const char *file,
                                                         const char *mode) {
  return &stubRWops;
}
...
extern DECLSPEC void SDLCALL SDL_WarpMouseInWindow(SDL_Window *window, int x,
                                                   int y) {}

extern DECLSPEC int SDLCALL SDL_WM_IconifyWindow() { return 0; }
...
extern DECLSPEC int SDLCALL SDL_EnableKeyRepeat(int i, int j) { return 0; }
...
extern DECLSPEC char *SDLCALL SDL_GetClipboardText() { return ""; }
...
extern DECLSPEC SDL_Keymod SDLCALL SDL_GetModState() { return 0; }
...
extern DECLSPEC Uint32 SDLCALL SDL_GetMouseState(int *x, int *y) { return 0; }

extern DECLSPEC int SDLCALL SDL_NumJoysticks() { return 0; }

extern DECLSPEC const char *SDLCALL
SDL_JoystickName(SDL_Joystick *device_index) {
  return "";
}
...
extern DECLSPEC Uint8 SDLCALL SDL_GetAppState() { return 0; }

extern DECLSPEC int SDL_GetNumVideoDisplays(void) { return 0; }

extern DECLSPEC SDL_bool SDL_HasIntersection(const SDL_Rect *A,
                                             const SDL_Rect *B) {
  return SDL_TRUE;
}

extern DECLSPEC SDL_bool SDL_IntersectRect(const SDL_Rect *A, const SDL_Rect *B,
                                           SDL_Rect *result) {
  return SDL_TRUE;
}
...
extern DECLSPEC int SDL_GetDisplayUsableBounds(int displayIndex,
                                               SDL_Rect *rect) {
  if (rect == 0)
    return -1;
  rect->w = 640;
...
extern DECLSPEC int SDLCALL SDL_GL_SetSwapInterval(int interval) { return 0; }
...
extern DECLSPEC int SDLCALL SDL_CaptureMouse(SDL_bool capture) { return 0; }
...
extern DECLSPEC int SDLCALL SDL_UpperBlit(SDL_Surface *src,
