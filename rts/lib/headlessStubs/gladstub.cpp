...
decltype(glad_glBindShadingRateImageNV) glad_glBindShadingRateImageNV = nullptr;
...
decltype(glad_glShadingRateImageBarrierNV) glad_glShadingRateImageBarrierNV = nullptr;
decltype(glad_glShadingRateImagePaletteNV) glad_glShadingRateImagePaletteNV = nullptr;
...
int gladLoadGL(void) {
    ...
    glad_glBindShadingRateImageNV = MakeStubImpl(glad_glBindShadingRateImageNV);
    ...
    glad_glShadingRateImageBarrierNV = MakeStubImpl(glad_glShadingRateImageBarrierNV);
    glad_glShadingRateImagePaletteNV = MakeStubImpl(glad_glShadingRateImagePaletteNV);
