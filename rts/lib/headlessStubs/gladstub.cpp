...
GLenum APIENTRY impl_glCheckFramebufferStatus(GLenum target) { return GL_FRAMEBUFFER_COMPLETE; }

void APIENTRY impl_glGetActiveUniformsiv(GLuint program,
    GLsizei uniformCount,
    const GLuint* uniformIndices,
    GLenum pname,
    GLint* params)
{
	for (GLsizei i = 0; i < uniformCount; ++i) params[i] = 0;
}
...
void APIENTRY impl_glGetFloatv(GLenum pname, GLfloat* params) { *params = 0; }

void APIENTRY impl_glGetBooleanv(GLenum pname, GLboolean* params) { *params = 0; }

GLuint APIENTRY impl_glGenLists(GLsizei range) { return 0; }

const GLubyte* APIENTRY impl_glGetString(GLenum name) { return (const GLubyte*)""; }
...
decltype(glad_glDrawElementsInstancedBaseVertexBaseInstance) glad_glDrawElementsInstancedBaseVertexBaseInstance =
    nullptr;
...
namespace Impl {
template<typename R, typename... Args> auto MakeDefaultLambdaHelper(R (*)(Args...))
{
...
template<typename Func> auto MakeStubImpl(Func&& func) { return Impl::MakeDefaultLambdaHelper(func); }
...
int gladLoadGL(void)
{
	...
	glad_glDrawElementsInstancedBaseVertexBaseInstance =
	    MakeStubImpl(glad_glDrawElementsInstancedBaseVertexBaseInstance);
