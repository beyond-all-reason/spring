...
#define GLAD_GL_GET_FUN(x) x

#define GLAD_GL_VERSION 1

#define GLAD_GL_VERSION_1_1   GL_TRUE
#define GLAD_GL_VERSION_1_2   GL_TRUE
#define GLAD_GL_VERSION_1_2_1 GL_TRUE
#define GLAD_GL_VERSION_1_3   GL_TRUE
#define GLAD_GL_VERSION_1_4   GL_TRUE
#define GLAD_GL_VERSION_1_5   GL_FALSE
#define GLAD_GL_VERSION_2_0   GL_FALSE
#define GLAD_GL_VERSION_2_1   GL_FALSE
#define GLAD_GL_VERSION_3_0   GL_FALSE
#define GLAD_GL_VERSION_3_1   GL_FALSE
#define GLAD_GL_VERSION_3_2   GL_FALSE
#define GLAD_GL_VERSION_3_3   GL_FALSE
#define GLAD_GL_VERSION_4_0   GL_FALSE
#define GLAD_GL_VERSION_4_1   GL_FALSE
#define GLAD_GL_VERSION_4_2   GL_FALSE
#define GLAD_GL_VERSION_4_3   GL_FALSE
#define GLAD_GL_VERSION_4_4   GL_FALSE
#define GLAD_GL_VERSION_4_5   GL_FALSE
#define GLAD_GL_VERSION_4_6   GL_FALSE

#define GLAD_GL_NV_vertex_program2 GL_FALSE
#define GLAD_GL_ARB_depth_clamp GL_FALSE
#define GLAD_GL_EXT_framebuffer_blit GL_FALSE
#define GLAD_GL_EXT_framebuffer_object GL_FALSE
#define GLAD_GL_EXT_stencil_two_side GL_TRUE
