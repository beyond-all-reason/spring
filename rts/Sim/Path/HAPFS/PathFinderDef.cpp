...
float CPathFinderDef::Heuristic(uint32_t srcSquareX,
    uint32_t srcSquareZ,
    uint32_t tgtSquareX,
    uint32_t tgtSquareZ,
...
bool CPathFinderDef::IsGoalBlocked(const MoveDef& moveDef,
...
CRectangularSearchConstraint::CRectangularSearchConstraint(const float3 startPos,
