...
public:
	...
	bool GenExplosion(unsigned int expGenID,
	    const float3& pos,
	    const float3& dir,
	    float damage,
	    float radius,
...
public:
	IExplosionGenerator()
	    : generatorID(CExplosionGeneratorHandler::EXPGEN_ID_INVALID)
	{
	}
	...
	virtual bool Explosion(const float3& pos,
	    const float3& dir,
	    float damage,
	    float radius,
	    float gfxMod,
...
public:
	...
	bool Explosion(const float3& pos,
	    const float3& dir,
	    float damage,
	    float radius,
	    float gfxMod,
...
private:
	void ParseExplosionCode(ProjectileSpawnInfo* psi,
