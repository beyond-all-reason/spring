...
#define offsetof_expgen(type, member)                                                                              \
	(size_t)(((char*)&((type*)0xe7707e77)->member) - ((char*)(static_cast<CExpGenSpawnable*>((type*)0xe7707e77))))
...
#define CHECK_MEMBER_INFO_INT(type, member)                                                                         \
	...
	SET_MEMBER_INFO(memberInfo, MEMBER_HASH(member), offsetof_expgen(type, member), sizeof_expgen(type, member), 1, \
...
#define CHECK_MEMBER_INFO_FLOAT(type, member)                                                                       \
	...
	SET_MEMBER_INFO(memberInfo, MEMBER_HASH(member), offsetof_expgen(type, member), sizeof_expgen(type, member), 1, \
	    SExpGenSpawnableMemberInfo::TYPE_FLOAT, nullptr);

#define CHECK_MEMBER_INFO_FLOAT3(type, member)                                                                        \
	static_assert(std::is_same<decltype(member), float3>::value, "Member type mismatch");                             \
	SET_MEMBER_INFO(memberInfo, MEMBER_HASH(member), offsetof_expgen(type, member), sizeof_expgen(type, member.x), 3, \
	    SExpGenSpawnableMemberInfo::TYPE_FLOAT, nullptr);

#define CHECK_MEMBER_INFO_FLOAT4(type, member)                                                                        \
	static_assert(std::is_same<decltype(member), float4>::value, "Member type mismatch");                             \
	SET_MEMBER_INFO(memberInfo, MEMBER_HASH(member), offsetof_expgen(type, member), sizeof_expgen(type, member.x), 4, \
	    SExpGenSpawnableMemberInfo::TYPE_FLOAT, nullptr);
...
#define CHECK_MEMBER_INFO_PTR(t, member, callback)                                                                     \
	...
	SET_MEMBER_INFO(memberInfo, MEMBER_HASH(member), offsetof_expgen(t, member), sizeof_expgen(t, member), 1,          \
	    SExpGenSpawnableMemberInfo::TYPE_PTR, [](const std::string& s) { return (void*)callback(s.c_str()); });
...
#define CHECK_MEMBER_INFO_INT_HASH(type, member, memberHash)                                               \
	static_assert(std::is_integral<decltype(member)>::value, "Member type mismatch");                      \
	SET_MEMBER_INFO(memberInfo, memberHash, offsetof_expgen(type, member), sizeof_expgen(type, member), 1, \
	    SExpGenSpawnableMemberInfo::TYPE_INT, nullptr);
...
#define CHECK_MEMBER_INFO_FLOAT3_HASH(type, member, memberHash)                                              \
	static_assert(std::is_same<decltype(member), float3>::value, "Member type mismatch");                    \
	SET_MEMBER_INFO(memberInfo, memberHash, offsetof_expgen(type, member), sizeof_expgen(type, member.x), 3, \
	    SExpGenSpawnableMemberInfo::TYPE_FLOAT, nullptr);

#define CHECK_MEMBER_INFO_FLOAT4_HASH(type, member, memberHash)                                              \
	static_assert(std::is_same<decltype(member), float4>::value, "Member type mismatch");                    \
	SET_MEMBER_INFO(memberInfo, memberHash, offsetof_expgen(type, member), sizeof_expgen(type, member.x), 4, \
	    SExpGenSpawnableMemberInfo::TYPE_FLOAT, nullptr);

#define CHECK_MEMBER_INFO_PTR_HASH(t, member, callback, memberHash)                                                    \
	static_assert(std::is_same<decltype(callback("")), decltype(member)>::value, "Member and callback type mismatch"); \
	SET_MEMBER_INFO(memberInfo, memberHash, offsetof_expgen(t, member), sizeof_expgen(t, member), 1,                   \
	    SExpGenSpawnableMemberInfo::TYPE_PTR, [](const std::string& s) { return (void*)callback(s); });
