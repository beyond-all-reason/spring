...
static constexpr uint8_t RAS_ABS = 0x39;
...
static constexpr uint8_t RAS_KSINE = 0x3F;
static constexpr uint8_t RAS_KCOSINE = 0x40;
...
static void* ras_dispatch_table[] = {
			&& DO_RAS_PUSH_CONSTANT,&& DO_RAS_SLEEP };
