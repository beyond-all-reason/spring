...
static bool ParseBlendMode(const std::string& word, unsigned int& mode)
{
	...
	case hashString("src_alpha"): {
		mode = GL_SRC_ALPHA;
		return true;
	} break;
	case hashString("src_color"): {
		mode = GL_SRC_COLOR;
		return true;
	} break;
	case hashString("one_minus_src_alpha"): {
		mode = GL_ONE_MINUS_SRC_ALPHA;
		return true;
	} break;
	case hashString("one_minus_src_color"): {
		mode = GL_ONE_MINUS_SRC_COLOR;
		return true;
	} break;
	case hashString("dst_alpha"): {
		mode = GL_DST_ALPHA;
		return true;
	} break;
	case hashString("dst_color"): {
		mode = GL_DST_COLOR;
		return true;
	} break;
	case hashString("one_minus_dst_alpha"): {
		mode = GL_ONE_MINUS_DST_ALPHA;
		return true;
	} break;
	case hashString("one_minus_dst_color"): {
		mode = GL_ONE_MINUS_DST_COLOR;
		return true;
	} break;
	case hashString("src_alpha_saturate"): {
		mode = GL_SRC_ALPHA_SATURATE;
		return true;
	} break;
	default: {
	} break;
