...
CONFIG(float, CamSpringMinZoomDistance).defaultValue(20.0f).description("Minimum camera zoom distance, note this is the distance from frustum location to the ground in the direction of view");
