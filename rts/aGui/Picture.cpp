...
void Picture::DrawSelf()
{
	if (texture) {
		...
		rb.AddQuadTriangles({pos[0], pos[1], 0.0f, 1.0f, color}, {pos[0] + size[0], pos[1], 1.0f, 1.0f, color},
		    {pos[0] + size[0], pos[1] + size[1], 1.0f, 0.0f, color}, {pos[0], pos[1] + size[1], 0.0f, 0.0f, color});
