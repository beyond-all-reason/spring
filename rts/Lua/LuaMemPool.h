...
private:
	...
	static constexpr size_t INTERNAL_ALIGNMENT_SIZE = 64;
	static constexpr size_t MAX_INTERNAL_ALLOC_SIZE = 1 << 16;
	using LuaMemPoolImpl = PassThroughPool<LUA_MEM_POOL_SIZE_MB * (1024 * 1024), INTERNAL_ALIGNMENT_SIZE, MAX_INTERNAL_ALLOC_SIZE>;
