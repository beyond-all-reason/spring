 ...
 * @param weaponDefID number? Synced Only
 * @param projectileID number? Synced Only
 * @param attackerID number? Synced Only
 * @param attackerDefID number? Synced Only
 * @param attackerTeam number? Synced Only
 *
