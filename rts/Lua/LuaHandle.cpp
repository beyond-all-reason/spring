 ...
 * @tparam table winningAllyTeams list of winning allyTeams, if empty the game result was undecided (like when dropping from an host).
 */
...
/*** Called every `Update`.
 *
 * Must return true for `Mouse*` events and `GetToolTip` to be called.
 *
 * @function IsAbove
 * @number x
 * @number y
