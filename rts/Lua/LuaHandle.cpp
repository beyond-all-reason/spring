...
bool CLuaHandle::ControllerAdded(int deviceIndex)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 3, __func__);
	static const LuaHashString cmdStr(__func__);
...
bool CLuaHandle::ControllerRemoved(int instanceId)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 3, __func__);
	static const LuaHashString cmdStr(__func__);
...
bool CLuaHandle::ControllerConnected(int instanceId)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 3, __func__);
	static const LuaHashString cmdStr(__func__);
...
bool CLuaHandle::ControllerDisconnected(int instanceId)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 3, __func__);
	static const LuaHashString cmdStr(__func__);
...
bool CLuaHandle::ControllerRemapped(int instanceId)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 3, __func__);
	static const LuaHashString cmdStr(__func__);
...
bool CLuaHandle::ControllerButtonDown(int instanceId, int buttonId, int state)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 6, __func__);
	static const LuaHashString cmdStr(__func__);
	...
	lua_pushsstring(L, SDL_GameControllerGetStringForButton((SDL_GameControllerButton)buttonId));
...
bool CLuaHandle::ControllerButtonUp(int instanceId, int buttonId, int state)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 6, __func__);
	static const LuaHashString cmdStr(__func__);
...
bool CLuaHandle::ControllerAxisMotion(int instanceId, int axisId, int value)
{
	LUA_CALL_IN_CHECK(L, false);
	luaL_checkstack(L, 6, __func__);
	static const LuaHashString cmdStr(__func__);
	...
	lua_pushnumber(L, instanceId);
	lua_pushnumber(L, axisId);
	lua_pushnumber(L, value);
	lua_pushsstring(L, SDL_GameControllerGetStringForAxis((SDL_GameControllerAxis)axisId));
