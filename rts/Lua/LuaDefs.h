...
#define ADD_INT(lua, cpp) paramMap[lua] = DataElement(GetDataType(cpp), ADDRESS(cpp) - start)

#define ADD_BOOL(lua, cpp) paramMap[lua] = DataElement(GetDataType(cpp), ADDRESS(cpp) - start)

#define ADD_FLOAT(lua, cpp) paramMap[lua] = DataElement(GetDataType(cpp), ADDRESS(cpp) - start)

#define ADD_STRING(lua, cpp) paramMap[lua] = DataElement(GetDataType(cpp), ADDRESS(cpp) - start)

#define ADD_FUNCTION(lua, cpp, func) paramMap[lua] = DataElement(FUNCTION_TYPE, ADDRESS(cpp) - start, func)
...
#define ADD_DEPRECATED_LUADEF_KEY(lua) paramMap[lua] = DataElement();
