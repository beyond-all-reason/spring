...
public:
	...
	sol::as_table_t<std::vector<lua_Number>> Download(
	    sol::optional<int> attribIdxOpt,
	    sol::optional<int> elemOffsetOpt,
	...
	size_t InstanceDataFromUnitDefIDs(
	...
	size_t InstanceDataFromFeatureDefIDs(
	    const sol::stack_table& ids,
	    int attrID,
	    sol::optional<int> teamIdOpt,
	    sol::optional<int> elemOffsetOpt
...
private:
	...
	size_t MatrixDataFromProjectileIDsImpl(
	    const Iterable& ids,
	    int attrID,
	    sol::optional<int> elemOffsetOpt,
	    const char* func
