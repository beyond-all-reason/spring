...
public: // call-ins
	...
	std::pair<bool, bool>
	AllowUnitCreation(const UnitDef* unitDef, const CUnit* builder, const BuildInfo* buildInfo) override;
...
public: // Non-eventhandler call-ins
	...
	bool RecvLuaMsg(const std::string& msg, int playerID) { return syncedLuaHandle.RecvLuaMsg(msg, playerID); }
...
protected:
	...
	bool IsValid() const { return (syncedLuaHandle.IsValid() && unsyncedLuaHandle.IsValid()); }
