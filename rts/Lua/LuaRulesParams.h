...
enum {
	...
	// note: the following constants include all states beneath them (e.g. PRIVATE_MASK includes
	// PUBLIC,ALLIED,INLOS,...)
	RULESPARAMLOS_PRIVATE_MASK = RULESPARAMLOS_PUBLIC | RULESPARAMLOS_INRADAR | RULESPARAMLOS_TYPED |
	                             RULESPARAMLOS_INLOS | RULESPARAMLOS_ALLIED | RULESPARAMLOS_PRIVATE,
	RULESPARAMLOS_ALLIED_MASK =
	    RULESPARAMLOS_PUBLIC | RULESPARAMLOS_INRADAR | RULESPARAMLOS_TYPED | RULESPARAMLOS_INLOS | RULESPARAMLOS_ALLIED,
