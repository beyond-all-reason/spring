...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaConstGL.cpp#L26-L40" target="_blank">source</a>]
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaFBOs.cpp#L420-L423" target="_blank">source</a>]
...
```lua
function Spring.SetFeatureDirection(featureID: integer, frontx: number, fronty: number, frontz: number, rightx: number, righty: number, rightz: number)
  -> nil
```
...
```lua
function Spring.SetFeatureRotation(featureID: integer, pitch: number, yaw: number, roll: number)
  -> nil
```
...
```lua
function Spring.SetUnitDirection(unitID: integer, frontx: number, fronty: number, frontz: number, rightx: number, righty: number, rightz: number)
  -> nil
```
...
```lua
function Spring.SetUnitRotation(unitID: integer, pitch: number, yaw: number, roll: number)
  -> nil
```
...
```lua
(method) VBO:BindBufferRange(index: integer, elementOffset?: integer, elementCount?: number, target?: number)
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1431-L1445" target="_blank">source</a>]
...
```lua
(method) VBO:Define(size: number, attribs: number|VBOAttributeDef[])
  -> nil
```
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L499-L537" target="_blank">source</a>]
...
See:
  * ~GL.OpenGL_Data_Types~
  * [VBO](file:///home/runner/work/spring/spring/rts/Lua/library/generated/LuaVBOImpl.lua#13#10) :Upload
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L109-L113" target="_blank">source</a>]

## Download


```lua
(method) VBO:Download(attributeIndex?: integer, elementOffset?: integer, elementCount?: number, forceGPURead?: boolean)
  -> vboData: [number, unknown][]
```

[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L677-L688" target="_blank">source</a>]
...
```lua
(method) VBO:DumpDefinition()
  -> nil
```

Logs the definition of the VBO to the console

[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1467-L1471" target="_blank">source</a>]

## GetBufferSize


```lua
(method) VBO:GetBufferSize()
  -> elementsCount: number
  2. bufferSizeInBytes: number
  3. size: number
```

[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L585-L591" target="_blank">source</a>]
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1488-L1492" target="_blank">source</a>]

## InstanceDataFromFeatureDefIDs


```lua
(method) VBO:InstanceDataFromFeatureDefIDs(featureDefIDs: number|number[], attrID: integer, teamIdOpt?: integer, elementOffset?: integer)
  -> instanceData: [number, number, number, number]
  2. elementOffset: integer
  3. attrID: integer
```
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1244-L1269" target="_blank">source</a>]

## InstanceDataFromFeatureIDs


```lua
(method) VBO:InstanceDataFromFeatureIDs(featureIDs: number|number[], attrID: integer, teamIdOpt?: integer, elementOffset?: integer)
  -> instanceData: [number, number, number, number]
  2. elementOffset: integer
  3. attrID: integer
```
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1321-L1337" target="_blank">source</a>]

## InstanceDataFromUnitDefIDs


```lua
(method) VBO:InstanceDataFromUnitDefIDs(unitDefIDs: number|number[], attrID: integer, teamIdOpt?: integer, elementOffset?: integer)
  -> instanceData: [number, number, number, number]
  2. elementOffset: integer
  3. attrID: integer
```
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1205-L1230" target="_blank">source</a>]

## InstanceDataFromUnitIDs


```lua
(method) VBO:InstanceDataFromUnitIDs(unitIDs: number|number[], attrID: integer, teamIdOpt?: integer, elementOffset?: integer)
  -> instanceData: [number, number, number, number]
  2. elementOffset: integer
  3. attrID: integer
```
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1283-L1309" target="_blank">source</a>]

## MatrixDataFromProjectileIDs


```lua
(method) VBO:MatrixDataFromProjectileIDs(projectileIDs: integer|integer[], attrID: integer, teamIdOpt?: integer, elementOffset?: integer)
  -> matDataVec: number[]
  2. elemOffset: integer
  3. attrID: integer|[integer, integer, integer, integer]
```

[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1349-L1359" target="_blank">source</a>]
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1186-L1193" target="_blank">source</a>]
...
```lua
(method) VBO:UnbindBufferRange(index: integer, elementOffset?: integer, elementCount?: number, target?: number)
  -> bindingIndex: number
```

[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L1452-L1460" target="_blank">source</a>]
...
```lua
(method) VBO:Upload(vboData: number[], attributeIndex?: integer, elemOffset?: integer, luaStartIndex?: integer, luaFinishIndex?: integer)
  -> indexData: number[]
  2. elemOffset: integer
  3. attrID: integer|[integer, integer, integer, integer]
```
...
[<a href="https://github.com/beyond-all-reason/spring/blob/bc618fe4fc7c0955b111718fd6c25e33e28a450b/rts/Lua/LuaVBOImpl.cpp#L602-L634" target="_blank">source</a>]
...
See: [VBO](file:///home/runner/work/spring/spring/rts/Lua/library/generated/LuaVBOImpl.lua#13#10) :Define
