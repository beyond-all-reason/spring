...
{
#define CHECK_DIR_EXTRACTION(path, dir) CHECK(FileSystem::GetDirectory(path) == dir)
...
{
#define CHECK_NORM_PATH(path, normPath) CHECK(FileSystem::GetNormalizedPath(path) == normPath)
