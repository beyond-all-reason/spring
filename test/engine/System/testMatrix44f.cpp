...
{
	const float v0 = m.md[0][0] * vin.x + m.md[1][0] * vin.y + m.md[2][0] * vin.z + m.md[3][0] * vin.w;
	const float v1 = m.md[0][1] * vin.x + m.md[1][1] * vin.y + m.md[2][1] * vin.z + m.md[3][1] * vin.w;
	const float v2 = m.md[0][2] * vin.x + m.md[1][2] * vin.y + m.md[2][2] * vin.z + m.md[3][2] * vin.w;
	// w-component matters for float4::operator +=
	// the comparison with MatrixMultiply2() would
	// also not be fair otherwise
	const float v3 = m.md[0][3] * vin.x + m.md[1][3] * vin.y + m.md[2][3] * vin.z + m.md[3][3] * vin.w;
...
{
	float4& out = *vout;
	out.x = m.md[0][0] * in.x + m.md[1][0] * in.y + m.md[2][0] * in.z + m.md[3][0] * in.w;
	out.y = m.md[0][1] * in.x + m.md[1][1] * in.y + m.md[2][1] * in.z + m.md[3][1] * in.w;
	out.z = m.md[0][2] * in.x + m.md[1][2] * in.y + m.md[2][2] * in.z + m.md[3][2] * in.w;
	out.w = m.md[0][3] * in.x + m.md[1][3] * in.y + m.md[2][3] * in.z + m.md[3][3] * in.w;
}
