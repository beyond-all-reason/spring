...
int main(int argc, char** argv)
{
	...
	for (int i = 0; i < unitCount; i++) {
		...
		printf("    [unit %3i]   %-16s  <%s>\n", i, unitName.c_str(), unitFullName.c_str());
	}
	printf("  SIDES\n");
...
static bool TestLuaParser()
{
	const string source = "for k, v in pairs(Test) do\n"
